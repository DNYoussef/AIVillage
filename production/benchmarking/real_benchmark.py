...
class RealModelBenchmark:
    ...
    def extract_multiple_choice_answer(self, response: str) -> int | None:
    ...
    def extract_number_from_answer(self, answer_text: str) -> float | None:
    ...
    def extract_number_from_response(self, response: str) -> float | None:
