...
class HttpHealthChecker(HealthChecker):
    ...
    def __init__(self, component_id: str, url: str, expected_status: int = 200, 
    ...
    async def check_health(self) -> HealthCheckResult:
        ...
        try:
            ...
            return HealthCheckResult(
                ...
                error=str(e),
                recovery_suggestions=["Check network connectivity", "Verify service is running", "Check firewall settings"]
            )
    ...
    async def check_health(self) -> HealthCheckResult:
        ...
        try:
            ...
            return HealthCheckResult(
                ...
                error=str(e),
                recovery_suggestions=["Check database server status", "Verify connection credentials", "Check network connectivity"]
            )
...
class SystemHealthMonitor:
    ...
    def get_component_health_history(self, component_id: str, 
                                   duration: Optional[timedelta] = None) -> List[HealthCheckResult]:
...
if __name__ == "__main__":
    async def demo():
        ...
        try:
            ...
            print(f"Components - Healthy: {summary.healthy_components}, Warning: {summary.warning_components}, Critical: {summary.critical_components}")
