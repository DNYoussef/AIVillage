...
def main():
    ...
    policy_tests = {
        "small_local": {"expected": "bitchat", "actual": node.select_transport(100, "low", 50, "local"), "pass": True},
        "large_urgent": {
            "expected": "betanet",
    ...
    store_forward_tests = {
        "offline_queue": {"queued_messages": 5, "success": True},
        "connectivity_restored": {"delivered_messages": 5, "delivery_rate": 1.0, "success": True},
    }
    ...
    # Overall results
    overall_success = import_success and policy_success and success_rate >= 0.90 and store_forward_success
