...
class CognatePretrainPipeline:
    ...
    def pretrain_models(self, 
                       ...
                       save_checkpoints: bool = True) -> list[dict[str, Any]]:
        """
        ...
        for i, model_info in enumerate(self.models_info):
            ...
            try:
                ...
                training_results = self._simulate_training(
                    model_path, synthetic_data, steps, learning_rate
                )
    ...
    def _simulate_training(self, model_path: Path, data: list[str], 
                          steps: int, lr: float) -> dict[str, Any]:
...
def run_pretraining_pipeline(models_info: list[dict[str, Any]], 
                           steps: int = 1000) -> list[dict[str, Any]]:
