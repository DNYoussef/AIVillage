    ...
    def get_training_schedule(self, stage: Optional[CurriculumStage] = None) -> Dict[str, Any]:
        ...
        schedule = {
            ...
            'optimization': {
                ...
                } if config.grokfast_enabled else None
            },
    ...
    def get_curriculum_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'next_stage': {
                ...
                'stage': list(CurriculumStage)[list(CurriculumStage).index(self.current_stage) + 1] 
                        if list(CurriculumStage).index(self.current_stage) < len(CurriculumStage) - 1 else None
            }
        }
