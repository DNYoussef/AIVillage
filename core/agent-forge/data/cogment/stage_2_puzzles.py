...
class MazeGenerator:
    ...
    def _find_shortest_path(self, maze: np.ndarray, start: Tuple[int, int], 
    ...
    def _create_simple_path(self, maze: np.ndarray, start: Tuple[int, int], 
        ...
        for difficulty in self.difficulties:
            for puzzle_type in PuzzleType:
                config = PuzzleConfig(
                    ...
                    num_samples=self.samples_per_type,
                    seed=self.seed
                )
