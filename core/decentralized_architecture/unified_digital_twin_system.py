...
if __name__ == "__main__":
    ...
    async def demo():
        ...
        user_id = await twin.create_user(
            ...
            password="secure_password",  # nosec B106  # noqa: S106 - test demo password, not production
            display_name="Demo User",  # pragma: allowlist secret
        )

        # Authenticate user
        token = await twin.authenticate_user("demo_user", "secure_password")  # nosec B106  # noqa: S106 - test demo password
