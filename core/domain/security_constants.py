...
class AuthenticationMethod(Enum):
    ...
    PASSWORD = "password"  # noqa: S105 - string literal, not password  # pragma: allowlist secret
    TOKEN = "token"  # noqa: S105 - string literal, not token
...
class SecurityActions(Enum):
    ...
    LOGOUT = "logout"
    PASSWORD_CHANGE = "password_change"  # noqa: S105 - event name, not password  # pragma: allowlist secret
