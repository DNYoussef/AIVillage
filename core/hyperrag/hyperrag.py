...
class HyperRAG:
    ...
    async def initialize(self):
        ...
        try:
            # Initialize simple stores for basic functionality
    ...
    def get_stats(self) -> dict[str, Any]:
        ...
        return {
            **self.stats,
            "vector_store_docs": len(self.vector_store.documents) if self.vector_store else 0,
            "graph_store_nodes": len(self.graph_store.nodes) if self.graph_store else 0,
