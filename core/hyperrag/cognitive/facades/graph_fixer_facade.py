...
class GraphFixerFacade:
    ...
    async def propose_solutions(
        ...
        try:
            ...
            proposed_nodes, proposed_relationships = await asyncio.gather(
                node_task, relationship_task
            )
            
            # Enhance proposals with confidence calculation
            await self._enhance_proposals_with_confidence(
                proposed_nodes, proposed_relationships, limited_gaps
            )
    ...
    async def get_gap_statistics(self) -> Dict[str, Any]:
        ...
        try:
            ...
            stats["aggregate"] = {
                ...
                "total_proposals": (
                    stats["node_proposal"]["nodes_proposed"] +
                    stats["relationship_analyzer"]["relationships_proposed"]
                ),
    ...
    async def perform_comprehensive_analysis(
        ...
        try:
            ...
            result = GapAnalysisResult(
                ...
                ) if (proposed_nodes or proposed_relationships) else 0.0,
                ...
                metadata={
                    "services_used": 6,
                    "analytics": analytics,
                    "service_stats": await self.get_gap_statistics()
                }
            )
    ...
    async def cleanup(self):
        ...
        try:
            cleanup_tasks = [
                service.cleanup() for service in [
                    self.gap_detection,
                    self.node_proposal,
