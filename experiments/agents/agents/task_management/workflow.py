...
class Workflow:
    ...
    def update_task(self, updated_task: Task) -> "Workflow":
        ...
        return Workflow(id=self.id, name=self.name, tasks=new_tasks, dependencies=self.dependencies)
    ...
    def add_dependency(self, task_id: str, dependency_id: str) -> "Workflow":
        ...
        return Workflow(id=self.id, name=self.name, tasks=self.tasks, dependencies=new_dependencies)
