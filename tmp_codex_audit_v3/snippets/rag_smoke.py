...
def test_rag_pipeline():
    ...
    try:
        ...
        if retrieved:
            ...
            print(
                f"[PASS] Retrieved {len(retrieved) if hasattr(retrieved, '__len__') else '?'} results"
            )
...
def main():
    ...
    overall_success = (
        results["import"] and results["instantiation"] and results["retrieve"]
    )
        ...
        json.dump(
            {
                ...
                "meets_target": results["latency_ms"] < 100
