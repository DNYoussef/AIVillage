...
class DigitalTwinValidator:
    ...
    def test_digital_twin_core(self):
    ...
    def test_preference_vault(self):
    ...
    def test_encryption_manager(self):
        ...
        try:
            ...
            if hasattr(encryption_manager, 'encrypt_data') and hasattr(encryption_manager, 'decrypt_data'):
                ...
                test_data = {
                    "sensitive_data": "user preferences and personal information",
                    "metadata": {"classification": "sensitive", "retention": "5_years"}
                }
        ...
        try:
            ...
            if hasattr(compliance_manager, 'validate_compliance') and hasattr(compliance_manager, 'get_consent_status'):
                ...
                test_operation = {
                    ...
                    "user_age": 16,
                    "data_categories": ["preferences", "usage_patterns"],
                    "consent_given": True,
