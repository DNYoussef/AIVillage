...
class PromptEngineeeringConfig:
    ...
    def __post_init__(self):
        if self.supported_languages is None:
            self.supported_languages = ["en", "es", "hi", "fr", "ar", "pt", "sw", "de", "it", "zh"]
...
class EnhancedAppConfig:
    ...
    def validate_config(self) -> dict[str, Any]:
        ...
        if self.prompt_engineering.prompt_optimization_threshold < 0 or self.prompt_engineering.prompt_optimization_threshold > 1:
