        ...
        bridges = [
            {
                ...
                "confidence": 0.73,
                "explanation": (
                    "Creative connection between " f"{source_concept} and {target_concept or 'related concepts'}"
                ),
    ...
    async def handle_repair(
        ...
        **kwargs,
        ...
        repair_proposals = [
            {
                "id": "proposal_001",
                "description": (f"Repair {violation_type}: " f"{details.get('description', 'Unknown issue')}"),
                "confidence": 0.92,
                "impact_analysis": {
                    "affected_nodes": 2,
                    "affected_edges": 1,
