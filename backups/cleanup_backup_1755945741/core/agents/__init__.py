...
# Import agent components directly - core agents module
try:
    from packages.agents.core.agent_interface import AgentCapability
except ImportError:
    # Fallback for reorganized structure
...
# SpecializedAgentRegistry = SpecialistAgentRegistry  # Disabled during reorganization
# get_global_registry = get_specialist_registry  # Disabled during reorganization
