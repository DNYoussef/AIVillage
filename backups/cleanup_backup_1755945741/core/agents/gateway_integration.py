...
class AgentGatewayInterface:
    ...
    async def _process_query(self, content: str, priority: TaskPriority, session_id: Optional[str], **kwargs) -> Dict[str, Any]:
    ...
    async def _process_analysis(self, content: str, priority: TaskPriority, session_id: Optional[str], **kwargs) -> Dict[str, Any]:
    ...
    async def _process_task(self, content: str, priority: TaskPriority, session_id: Optional[str], **kwargs) -> Dict[str, Any]:
    ...
    async def _process_conversation(self, content: str, priority: TaskPriority, session_id: Optional[str], **kwargs) -> Dict[str, Any]:
    ...
    async def _process_generic(self, content: str, priority: TaskPriority, session_id: Optional[str], **kwargs) -> Dict[str, Any]:
...
async def example_usage():
    ...
    requests = [
        ...
        },
        {
            ...
            'content': 'Market trends in renewable energy',
            'priority': 'normal'
        },
        {
