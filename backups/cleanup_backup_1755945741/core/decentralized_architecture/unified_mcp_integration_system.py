...
class MCPServerRegistry:
    ...
    def find_servers_by_capability(self, tool_category: MCPToolCategory) -> List[MCPServerSpec]:
        ...
        return [server for server in self.servers.values()
                if tool_category in server.tool_categories]
    ...
    async def send_request(self, server_id: str, request: MCPRequest) -> MCPResponse:
        ...
        if server_id not in self.connections:
            return MCPResponse(
                ...
                success=False,
                error={"code": -1, "message": "Not connected to server"}
            )
...
class UnifiedMCPIntegrationSystem:
    ...
    def get_system_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "p2p": {
                "p2p_discoveries": self.stats["p2p_discoveries"],
