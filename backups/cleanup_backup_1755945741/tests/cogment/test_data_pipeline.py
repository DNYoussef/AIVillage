...
try:
    from core.agent_forge.data.cogment.data_manager import (
        CogmentDataManager, DataLoadingStrategy, StageDataConfig
    )
...
class TestARCVisualDataset:
    ...
    def test_arc_augmentation_engine(self, arc_dataset, arc_config):
        ...
        base_task = {
            ...
            'output_grid': torch.randint(0, 10, (5, 5))
        }
    ...
    def test_arc_dataset_augmentation_count(self, arc_dataset, arc_config):
        ...
        assert augmentation_ratio >= expected_ratio * 0.8, \
...
class TestAlgorithmicPuzzleDataset:
    ...
    def test_puzzle_difficulty_distribution(self, puzzle_dataset, puzzle_config):
        ...
        assert actual_difficulties.issubset(expected_difficulties), \
...
class TestCogmentDataManager:
    ...
    def data_manager_config(self):
        ...
        return {
            'seed': 42,
            'demo_mode': True  # Reduced dataset sizes
        }
    ...
    def data_manager(self, data_manager_config):
        ...
        return CogmentDataManager(
            ...
            base_config=data_manager_config
        )
    ...
    def test_data_manager_loading_strategies(self):
        ...
        strategies = [
            DataLoadingStrategy.HYBRID,
            DataLoadingStrategy.ON_DEMAND,
            DataLoadingStrategy.SEQUENTIAL
        ]
        
        config = {'demo_mode': True, 'seed': 42}
        
        for strategy in strategies:
            manager = CogmentDataManager(
...
class TestARCAugmentationEngine:
    ...
    def test_augmentation_variety(self, augmentation_engine):
        ...
        base_task = {
            'input_grid': torch.randint(0, 10, (4, 4)),
            'output_grid': torch.randint(0, 10, (4, 4))
        }
    ...
    def test_augmentation_count_target(self, augmentation_engine):
        ...
        base_task = {
            'input_grid': torch.randint(0, 10, (3, 3)),
            'output_grid': torch.randint(0, 10, (3, 3))
        }
...
class TestDataPipelineIntegration:
    ...
    def test_pipeline_memory_efficiency(self):
        ...
        assert memory_used <= max_expected_memory, \
    ...
    def test_curriculum_progression_integration(self):
        ...
        manager = CogmentDataManager(
            loading_strategy=DataLoadingStrategy.SEQUENTIAL,
            base_config=config
        )
        ...
        if len(successful_stages) >= 2:
            ...
            configs_differ = (
                stage0['batch_size'] != stage1['batch_size'] or
                stage0['sequence_length'] != stage1['sequence_length'] or
                stage0['dataset_type'] != stage1['dataset_type']
            )
