...
class TestEndToEndQueries:
        ...
        try:
            ...
            for query_text, mode in queries:
                ...
                if mode == QueryMode.FAST:
                    ...
                    assert answer.synthesis_method == "creative_synthesis", "CREATIVE mode should use creative synthesis"
    ...
    def test_knowledge_graph_integration(self, sample_documents):
        ...
        try:
            ...
            answer = hyperrag.process_query(
                "Who created Python and what is their background?",
    ...
    async def test_cognitive_analysis_integration(self, sample_documents):
        ...
        try:
            ...
            assert answer.synthesis_method in ["multi_source_synthesis", "analytical_synthesis"], "Should use analytical synthesis"
    ...
    def test_performance_benchmarks(self, sample_documents):
        ...
        try:
            ...
            benchmarks = [
                ...
                ("Complex analytical query", "Compare and analyze machine learning vs neural networks", QueryMode.COMPREHENSIVE, 5.0),
                ("Creative synthesis query", "What innovative applications could combine Python and neural networks?", QueryMode.CREATIVE, 3.0)
            ]
