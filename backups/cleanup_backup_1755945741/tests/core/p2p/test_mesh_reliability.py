...
class ReliabilityValidator:
    ...
    async def test_retry_mechanism(self) -> Dict[str, Any]:
        ...
        protocol.add_peer("peer-retry", {
            TransportType.WEBSOCKET: {"host": "localhost", "port": 8081}
        })
        ...
        print(f"Retry mechanism: {delivery_rate:.2%} success rate with {unreliable_transport.success_rate:.2%} base transport")
        return results
    ...
    async def test_transport_failover(self) -> Dict[str, Any]:
        ...
        protocol.add_peer("peer-failover", {
            TransportType.WEBSOCKET: {"host": "localhost", "port": 8080},
    ...
    async def test_chunked_message_reliability(self) -> Dict[str, Any]:
        ...
        protocol.add_peer("peer-chunk", {
            TransportType.WEBSOCKET: {"host": "localhost", "port": 8082}
        })
    ...
    async def test_store_and_forward(self) -> Dict[str, Any]:
        ...
        protocol.add_peer("peer-store", {
            TransportType.WEBSOCKET: {"host": "localhost", "port": 8083}
        })
    ...
    async def test_performance_metrics(self) -> Dict[str, Any]:
        ...
        protocol.add_peer("peer-perf", {
            TransportType.WEBSOCKET: {"host": "localhost", "port": 8084}
        })
    ...
    async def test_network_partition_recovery(self) -> Dict[str, Any]:
        ...
        protocol.add_peer("partition-peer", {
    ...
    async def test_circuit_breaker_pattern(self) -> Dict[str, Any]:
        ...
        protocol.add_peer("failing-peer", {
            TransportType.BITCHAT: {"host": "localhost", "port": 8087}
        })
    ...
    def _calculate_reliability_summary(self) -> Dict[str, Any]:
        ...
        for test_name, result in test_results:
            if 'delivery_rate' in result:
                ...
                messages = result.get('total_messages', 0) or result.get('total_large_messages', 0) or result.get('total_stored_messages', 0)
...
async def test_mesh_reliability_validation():
    ...
    assert summary['overall_delivery_rate'] >= 0.90, f"Delivery rate {summary['overall_delivery_rate']:.2%} below 90% target"
...
async def main():
    ...
    try:
        ...
        import os
        results_dir = os.path.join(os.path.dirname(__file__), '..', '..', '..', '.claude', 'hive-mind', 'network-discoveries')
