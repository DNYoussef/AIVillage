...
try:
    from core.rag.hyper_rag import HyperRAG, RAGMode, QueryType
    from core.rag.memory.hippo_index import HippoIndex, EpisodicDocument
...
class TestHyperRAGIntegration:
    ...
    async def test_vector_similarity_accuracy(self, hyper_rag):
        ...
        for test_case in test_cases:
            ...
            if result and "results" in result:
                ...
                assert top_result_score >= test_case["min_score"], \
    ...
    async def test_concurrent_query_handling(self, hyper_rag, sample_queries):
        ...
        all_queries = (sample_queries["simple"] * 5 + 
                      sample_queries["complex"] * 3 + 
                      sample_queries["contextual"] * 2)[:50]
    ...
    async def test_knowledge_consolidation_validation(self, hyper_rag):
        ...
        if result and "metadata" in result:
            ...
            assert total_documents >= 422, \
                f"Only {total_documents} documents consolidated, expected ≥422"
            ...
            diverse_queries = [
                "AI ethics", "machine learning", "neural networks", 
