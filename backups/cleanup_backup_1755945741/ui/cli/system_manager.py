...
class AIVillageSystemManager:
    ...
    def setup_environment(self) -> bool:
        ...
        required_dirs = ["src", "packages", "tests", "ui", "infrastructure"]
...
For more information, see: docs/UI_SYSTEMS.md
    ...
    try:
        if args.command == "dashboard":
            ...
            return asyncio.run(
                manager.run_agent_forge(
                    config=args.config, models=args.models, benchmark=args.benchmark, output_dir=args.output_dir
                )
            )
