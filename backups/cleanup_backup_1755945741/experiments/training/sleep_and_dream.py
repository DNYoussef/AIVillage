...
class SleepNet(nn.Module):
    ...
    def __init__(
        self, input_size: int, output_size: int, num_sleep_blocks: int = 3, compression_ratios: list | None = None
    ):
        super().__init__()
...
class DreamNet(nn.Module):
    ...
    def __init__(
        self, input_size: int, output_size: int, num_dream_blocks: int = 3, creativity_levels: list | None = None
    ):
        super().__init__()
