...
class AgentRouter(nn.Module):
    def __init__(self, model_name="bert-base-uncased", cache_size=1000, confidence_threshold=0.7) -> None:
        super().__init__()
        ...
        self.tokenizer = AutoTokenizer.from_pretrained(model_name, revision="main", trust_remote_code=False)
    ...
    async def train_model(self, preference_data: list[dict], num_epochs=3, batch_size=32) -> None:
        self.train()
