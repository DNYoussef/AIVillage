...
if __name__ == "__main__":
    ...
    async def test_hyper_rag():
        """Test HyperRAG system."""
        ...
        await rag.store_document(
            ...
            discover representations from data.
            """,
        ...
        queries = [
            ...
            ("Explain AI and machine learning relationships", QueryMode.COMPREHENSIVE),
        ]
