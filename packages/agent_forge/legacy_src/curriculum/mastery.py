...
from .schemas import AttemptRecord, LastResult, MasteryAction, MasteryRequest, MasteryResponse, MasteryStatus
    ...
    def get_student_mastery_summary(self, student_id: str) -> dict[str, Any]:
        ...
        with sqlite3.connect(self.storage_path) as conn:
            ...
            return {
                ...
                "overall_accuracy": (
                    stats["total_correct"] / stats["total_attempts"] if stats["total_attempts"] > 0 else 0
                ),
                "status_distribution": {
