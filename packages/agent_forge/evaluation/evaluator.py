...
class AgentForgeEvaluator:
    ...
    def evaluate_hrrm_model(
        self, model_type: str, model: torch.nn.Module, specialized_data: Optional[List[Dict[str, Any]]] = None
    ) -> Dict[str, Any]:
        """
    ...
    def _load_model(self, model_path: Union[str, Path]) -> torch.nn.Module:
