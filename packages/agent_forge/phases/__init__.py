...
1. EvoMerge: Evolutionary model merging and optimization
2. Quiet-STaR: Reasoning enhancement with thought baking
3. BitNet Compression: 1.58-bit quantization compression
4. Forge Training: Main training loop with Grokfast acceleration
5. Tool & Persona Baking: Tool and persona specialization
6. ADAS: Architecture Discovery and Search with vector composition
7. Final Compression: SeedLM + VPTQ + Hypercompression stack

All phases implement the PhaseController interface for consistent
model passing and result reporting.
"""
...
def get_available_phases():
    """Get list of available phase controllers."""
    phases = []
