...
class AgentCapability(Enum):
    ...
    # Specialist capabilities (from legacy registries)
...
class AgentInterface(ABC):
    ...
    # Advanced RAG/communication interfaces
    ...
    async def rerank(self, query: str, results: list[dict[str, Any]], k: int) -> list[dict[str, Any]]:
        """Rerank retrieval results based on a query and return top *k*."""

    @abstractmethod
    async def introspect(self) -> dict[str, Any]:
        """Return introspection and diagnostic information about the agent."""

    @abstractmethod
    async def communicate(self, message: str, recipient: "AgentInterface") -> str:
        """Send a message to another agent and await its response."""

    @abstractmethod
    async def activate_latent_space(self, query: str) -> tuple[str, str]:
        """Return background knowledge and a refined query for latent space."""
