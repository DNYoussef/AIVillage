"""Merchant Agent - Marketplace & Credits"""
...
class MerchantAgent(AgentInterface):
    """Marketplace & Credits"""

    def __init__(self, agent_id: str = "merchant_agent"):
        self.agent_id = agent_id
        self.agent_type = "Merchant"
        self.capabilities = [
    ...
    async def generate(self, prompt: str) -> str:
        return "I am Merchant Agent, responsible for Marketplace & Credits."
    ...
    async def communicate(self, message: str, recipient: "AgentInterface") -> str:
        if recipient:
            response = await recipient.generate(f"Merchant Agent says: {message}")
