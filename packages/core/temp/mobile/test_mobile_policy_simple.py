...
class SimpleBatteryThermalResourceManager:
    ...
    def _create_env_profile(self) -> MockDeviceProfile:
        ...
        if os.getenv("BATTERY"):
            try:
                ...
                profile.battery_charging = False  # Assume not charging if battery specified
            except ValueError:
                pass
    ...
    async def evaluate_and_adapt(self, profile: MockDeviceProfile | None = None) -> ResourceState:
