...
from ..training.curriculum import Question, CurriculumLevel, CurriculumGenerator
from ..training.magi_specialization import FrontierQuestionGenerator, MagiConfig
from .task_router import TaskRouter, TaskContext, TaskType
    ...
    def _generate_single_question(self, area: str, difficulty: int) -> Question:
        ...
        try:
            ...
            try:
                ...
                task = loop.create_task(self._generate_with_openrouter(area, difficulty))
