...
async def test_communications_protocol():
    ...
    try:
        ...
        if connected:
            message_sent = await agent1.send_message("test_agent_2", {
                "type": "test",
...
async def test_ppr_retriever():
    ...
    try:
        ...
        from mcp_servers.hyperag.memory.hippo_index import HippoIndex
...
async def test_system_health_dashboard():
    ...
    try:
        from monitoring.system_health_dashboard import SystemHealthDashboard, ComponentHealthChecker
