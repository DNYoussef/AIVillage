...
class SBOMGenerator:
    ...
    def __init__(self, project_root: str, output_dir: str):
        ...
        self.sbom.metadata = {
            ...
            "component": {
                ...
                "supplier": {"name": "AIVillage Team", "url": ["https://aivillage.dev"]},
            },
        }
    ...
    def _add_python_component(self, name: str, version: str, scope: str):
        ...
        component = Component(
            ...
            scope=scope,
            supplier={"name": "PyPI"},
            properties=[{"name": "ecosystem", "value": "python"}, {"name": "package_manager", "value": "pip"}],
        )
    ...
    def _add_nodejs_component(self, name: str, version: str, scope: str):
        ...
        component = Component(
            ...
            scope=scope,
            supplier={"name": "NPM"},
            properties=[{"name": "ecosystem", "value": "nodejs"}, {"name": "package_manager", "value": "npm"}],
        )
    ...
    def _add_rust_component(self, name: str, version: str, scope: str):
        ...
        component = Component(
            ...
            properties=[{"name": "ecosystem", "value": "rust"}, {"name": "package_manager", "value": "cargo"}],
        )
            ...
            if go_mod_file.exists():
                try:
                    ...
                    result = subprocess.run(
                        ["go", "list", "-json", "-m", "all"], cwd=go_mod_file.parent, capture_output=True, text=True
                    )
                            ...
                            if line.strip():
                                try:
                                    ...
                                    if "Path" in module_info and "Version" in module_info:
                                        self._add_go_component(module_info["Path"], module_info["Version"], "required")
    ...
    def _add_go_component(self, name: str, version: str, scope: str):
        ...
        component = Component(
            ...
            properties=[{"name": "ecosystem", "value": "go"}, {"name": "package_manager", "value": "go"}],
        )
    ...
    def _add_container_component(self, image: str):
        ...
        component = Component(
            ...
            scope="required",
            properties=[{"name": "ecosystem", "value": "container"}, {"name": "package_manager", "value": "docker"}],
        )
    ...
    def _generate_dependency_graph(self):
        ...
        for component in self.sbom.components:
            dependency = {"ref": component.bom_ref, "dependsOn": []}  # Would populate with actual dependencies
    ...
    def _generate_attestation(self):
        ...
        if cyclonedx_file.exists():
            ...
            attestation = {
                ...
                "subject": [{"name": "aivillage-sbom.cyclonedx.json", "digest": {"sha256": sbom_hash}}],
                "predicate": {
                    "timestamp": datetime.now(timezone.utc).isoformat(),
                    "generator": {"name": "AIVillage SBOM Generator", "version": "1.0.0"},
                    "evidence": {
