...
def generate_security_report() -> str:
    ...
    total_files = (
        len(validation_results["secure"]) + len(validation_results["insecure"]) + len(validation_results["mixed"])
    )
    if total_files > 0:
        ...
        print("   Security Score: No CORS configurations found")
    ...
    if wildcards:
        ...
        print("      Use: from src.security.cors_config import SECURE_CORS_CONFIG")
    else:
        print("   ✅ No wildcard CORS configurations found")
    ...
    if security_score < 90:
        print("   📊 Security score below 90% - recommend additional hardening")
    elif security_score >= 95:
        print("   🎯 Excellent security score - CORS hardening successful!")
    ...
    if cors_env:
        ...
        print("   CORS_ORIGINS: Not set (using defaults)")
