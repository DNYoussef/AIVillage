...
class CogmentConfigLoader:
    ...
    def _estimate_parameter_count(self, model_config: Dict[str, Any]) -> int:
        ...
        logger.debug(f"Parameter breakdown: embedding={embedding_params:,}, "
    ...
    def export_config_summary(self, config: CogmentCompleteConfig, output_path: Optional[Path] = None) -> Dict[str, Any]:
        """
