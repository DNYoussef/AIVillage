...
class CognateConfigLoader:
    ...
    def validate_config(self, config: dict[str, Any] | None = None) -> dict[str, Any]:
        ...
        validation_report = {"status": "passed", "errors": [], "warnings": [], "checks": {}}
    ...
    def estimate_parameter_count(self, config: dict[str, Any] | None = None) -> int:
        ...
        total_params = (
            embedding_params + layer_params + final_norm_params + lm_head_params + halting_head_params + memory_params
        )
    ...
    def create_cognate_config_object(self, config: dict[str, Any] | None = None) -> "CognateConfig":
        ...
        cognate_config = CognateConfig(
            ...
            layer_norm_eps=config.get("model_hyperparameters", {})
            .get("regularization", {})
            .get("layer_norm_eps", 1e-5),
        )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--environment", choices=["development", "staging", "production", "testing"], help="Environment to use"
    )
