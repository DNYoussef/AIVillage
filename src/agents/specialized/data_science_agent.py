...
class DataScienceAgent(AgentInterface):
    ...
    async def generate(self, prompt: str) -> str:
        ...
        if "statistical analysis" in prompt.lower():
            return f"I can perform statistical analysis. Please provide data source and analysis parameters."
        elif "machine learning" in prompt.lower():
            return f"I can train ML models. Specify the target variable and model type."
        elif "anomaly detection" in prompt.lower():
            return f"I can detect anomalies in your data using isolation forest or other methods."
        return f"I'm a Data Science Agent specialized in statistical analysis, ML training, and data insights."
    ...
    async def rerank(self, query: str, results: list[dict[str, Any]], k: int) -> list[dict[str, Any]]:
        ...
        keywords = ['analysis', 'model', 'data', 'statistics', 'prediction', 'regression', 'classification']
    ...
    async def perform_time_series_analysis(self, data: Any, config: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            results['trend'] = {
                ...
                'strength': float(np.corrcoef(range(len(decomposition.trend.dropna())), 
                                            decomposition.trend.dropna())[0, 1])
            }
