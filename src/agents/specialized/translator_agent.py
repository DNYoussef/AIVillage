...
class TranslatorAgent(AgentInterface):
    ...
    async def rerank(self, query: str, results: list[dict[str, Any]], k: int) -> list[dict[str, Any]]:
        keywords = ['translate', 'language', 'multilingual', 'localization', 'cultural', 'linguistic']
        ...
        try:
            ...
            return {
                ...
                'alternative_languages': [
                    {'language': lang, 'confidence': score/len(text.split()) if text.split() else 0}
        ...
        try:
            cultural_adaptations = {
                'us': {
                    ...
                    'cultural_notes': ['Direct communication style', 'Individual focus']
                },
                'uk': {
