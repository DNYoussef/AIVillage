...
class EnvironmentValidator:
    ...
    TYPE_RULES = {
        # Integer types
        "int": [
            "LIBP2P_PORT", "LIBP2P_WEBSOCKET_PORT", "MDNS_DISCOVERY_INTERVAL",
            "MDNS_TTL", "MESH_MAX_PEERS", "MESH_HEARTBEAT_INTERVAL",
            "MESH_CONNECTION_TIMEOUT", "MESH_MAX_MESSAGE_SIZE",
            "DIGITAL_TWIN_API_PORT", "EVOLUTION_METRICS_API_PORT",
            "RAG_PIPELINE_API_PORT", "P2P_STATUS_API_PORT",
            "RAG_L1_CACHE_SIZE", "RAG_VECTOR_DIM", "RAG_DEFAULT_K",
            "RAG_CHUNK_SIZE", "RAG_CHUNK_OVERLAP", "RAG_VECTOR_TOP_K",
            "RAG_KEYWORD_TOP_K", "RAG_FINAL_TOP_K", "RAG_BATCH_SIZE",
            "AIVILLAGE_METRICS_FLUSH_THRESHOLD", "REDIS_PORT", "REDIS_DB",
            "DIGITAL_TWIN_MAX_PROFILES", "DIGITAL_TWIN_PROFILE_TTL_DAYS",
            "DIGITAL_TWIN_DATA_RETENTION_DAYS", "API_RATE_LIMIT_PER_MINUTE",
            "API_JWT_EXPIRY_HOURS", "API_REFRESH_TOKEN_EXPIRY_DAYS",
            ...
            "MAX_MEMORY_MB", "MAX_FAISS_MEMORY_MB", "MAX_CACHE_MEMORY_MB",
            "MAX_CONCURRENT_QUERIES", "MAX_DOCUMENT_SIZE_MB",
            "MAX_BATCH_PROCESSES", "MAX_CONNECTIONS", "CONNECTION_TIMEOUT",
            "READ_TIMEOUT", "WRITE_TIMEOUT", "HEALTH_CHECK_INTERVAL",
            "HEALTH_CHECK_TIMEOUT", "BACKUP_INTERVAL_HOURS",
            "BACKUP_RETENTION_DAYS", "RECOVERY_MAX_RETRIES",
            "RECOVERY_RETRY_DELAY"
        ],
        # Float types
        "float": [
            "RAG_SIMILARITY_THRESHOLD", "RAG_CACHE_TTL_HOURS"
        ],
        # Boolean types
        "bool": [
            "RAG_CACHE_ENABLED", "RAG_RERANK_ENABLED", "MDNS_ENABLED",
            "MESH_ENABLE_TCP", "MESH_ENABLE_WEBSOCKET", "MESH_ENABLE_BLUETOOTH",
            "MESH_ENABLE_WIFI_DIRECT", "MESH_ENABLE_FILE_TRANSPORT",
            "MESH_TLS_ENABLED", "MESH_PEER_VERIFICATION", "MESH_ENCRYPTION_REQUIRED",
            "DIGITAL_TWIN_SQLITE_WAL", "DIGITAL_TWIN_BACKUP_ENCRYPTION",
            "DIGITAL_TWIN_COPPA_COMPLIANT", "DIGITAL_TWIN_FERPA_COMPLIANT",
            "DIGITAL_TWIN_GDPR_COMPLIANT", "DIGITAL_TWIN_ANALYTICS_ENABLED",
            "DIGITAL_TWIN_TELEMETRY_ENABLED", "DIGITAL_TWIN_AUDIT_LOG_ENABLED",
            "API_CORS_ENABLED", "API_AUTH_ENABLED", "AIVILLAGE_DEBUG_MODE",
            "AIVILLAGE_PROFILE_PERFORMANCE", "AIVILLAGE_ENABLE_METRICS",
            "HEALTH_CHECK_ENABLED", "TEST_DISABLE_AUTH", "TEST_MOCK_EXTERNAL_SERVICES",
            "TEST_FAST_MODE", "DEV_AUTO_RELOAD", "DEV_DEBUG_TOOLBAR",
            "DEV_MOCK_P2P", "DEV_SEED_DATA", "MOBILE_P2P_ENABLED",
            "MOBILE_OFFLINE_MODE", "MOBILE_BATTERY_OPTIMIZATION",
            "TLS_VERIFY_PEER", "SECURITY_HSTS_ENABLED", "SECURITY_CSP_ENABLED",
            "RATE_LIMIT_ENABLED", "BACKUP_ENABLED", "BACKUP_COMPRESS",
            "AUTO_RECOVERY_ENABLED", "FEATURE_ADVANCED_ANALYTICS",
            "FEATURE_MULTI_TENANT", "FEATURE_BLOCKCHAIN_INTEGRATION",
            "FEATURE_FEDERATED_LEARNING", "LEGACY_API_SUPPORT",
            "LEGACY_DATA_FORMAT", "ASYNC_PROCESSING", "BATCH_OPTIMIZATION",
            "LAZY_LOADING"
        ],
        # Path types (file or directory)
        "path": [
            "AIVILLAGE_DB_PATH", "AIVILLAGE_LOG_DIR", "RAG_DISK_CACHE_DIR",
            "RAG_FAISS_INDEX_PATH", "RAG_BM25_CORPUS_PATH", "RAG_CHUNK_STORE_PATH",
            "LIBP2P_PEER_ID_FILE", "LIBP2P_PRIVATE_KEY_FILE",
            "MESH_FILE_TRANSPORT_DIR", "DIGITAL_TWIN_VAULT_PATH",
            "DIGITAL_TWIN_DB_PATH", "AIVILLAGE_LOG_FILE", "TLS_CERT_FILE",
            "TLS_KEY_FILE", "TLS_CA_FILE", "BACKUP_STORAGE_PATH",
            "HUGGINGFACE_CACHE_DIR"
        ],
        # URL types
        "url": [
            "AIVILLAGE_REDIS_URL", "RAG_REDIS_URL", "MOBILE_API_BASE_URL"
        ],
    ...
    def __init__(self, env_profile: str = "development"):
        ...
        try:
            if expected_type == "int":
                ...
                if not (value.startswith("http://") or value.startswith("https://") or
                       value.startswith("redis://") or value.startswith("mongodb://")):
                    return False
    ...
    def _validate_environment_profile(self, env_vars: dict[str, str]) -> None:
        ...
        if env_type == "production":
            ...
            debug_vars = ["AIVILLAGE_DEBUG_MODE", "DEV_AUTO_RELOAD", "DEV_DEBUG_TOOLBAR"]
    ...
    def generate_report(self) -> str:
        ...
        if self.report.issues:
            ...
            if info:
                ...
                for issue in info:
                    report_lines.extend([
                        f"ℹ️  {issue.variable}: {issue.message}",
                        ""
                    ])
        else:
        ...
        report_lines.extend([
            "",
            "="*80,
            "Generated by AIVillage Environment Validator",
            "="*80
        ])
...
def validate_environment(env_profile: str = None) -> ValidationReport:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--profile", choices=["development", "testing", "staging", "production"],
                       default="development", help="Environment profile to validate")
