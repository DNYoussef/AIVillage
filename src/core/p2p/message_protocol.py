...
class EvolutionMessage:
    ...
    evolution_type: Optional[str] = None  # nightly, breakthrough, emergency
...
class MessageProtocol:
    ...
    async def send_message(self, message: Union[EvolutionMessage, Dict], writer: asyncio.StreamWriter):
    ...
    async def handle_message(self, message_data: bytes, writer: asyncio.StreamWriter):
    ...
    async def _send_acknowledgment(self, original_message: EvolutionMessage, writer: asyncio.StreamWriter):
    ...
    def _update_type_stats(self, message_type: MessageType, direction: str):
    ...
    async def handle_ping(self, message: EvolutionMessage, writer: asyncio.StreamWriter):
        """Handle PING message"""
    ...
    async def handle_pong(self, message: EvolutionMessage, writer: asyncio.StreamWriter):
        """Handle PONG message"""
    ...
    async def handle_heartbeat(self, message: EvolutionMessage, writer: asyncio.StreamWriter):
    ...
    async def handle_peer_discovery(self, message: EvolutionMessage, writer: asyncio.StreamWriter):
    ...
    async def handle_peer_introduction(self, message: EvolutionMessage, writer: asyncio.StreamWriter):
    ...
    async def handle_peer_announcement(self, message: EvolutionMessage, writer: asyncio.StreamWriter):
    ...
    async def handle_peer_goodbye(self, message: EvolutionMessage, writer: asyncio.StreamWriter):
    ...
    async def handle_acknowledgment(self, message: EvolutionMessage, writer: asyncio.StreamWriter):
    ...
    async def handle_error(self, message: EvolutionMessage, writer: asyncio.StreamWriter):
    ...
    async def handle_resource_status(self, message: EvolutionMessage, writer: asyncio.StreamWriter):
    ...
    async def send_evolution_message(self, 
        ...
        if recipient_id:
            ...
            for peer_id, writer in self.p2p_node.connections.items():
                await self.send_message(message, writer)
                
        return message.message_id
        
    async def wait_for_response(self, correlation_id: str, timeout: float = 30.0) -> Optional[EvolutionMessage]:
