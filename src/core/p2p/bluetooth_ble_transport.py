...
class BleakAdapter:
    ...
    async def connect(self, address: str) -> bool:
        ...
        try:
            ...
            await client.start_notify(
                ...
                lambda sender, data: self.transport.handle_received_message(address, data),
            )
    ...
    async def stop_advertising(self):
        ...
        logger.debug("Stop advertising called - Bleak does not support BLE advertising (client-only)")
