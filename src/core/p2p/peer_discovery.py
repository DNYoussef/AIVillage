...
class PeerDiscovery:
    ...
    def _process_discovery_response(
        ...
        try:
            ...
            logger.exception(
                f"Error processing discovery response from {host}:{port}: {e}"
            )

    async def _connect_to_discovered_peer(
        self, host: str, port: int, peer_id: str
    ) -> None:
            ...
            try:
                ...
                class P2PServiceListener(ServiceListener):
                    ...
                    def remove_service(
                        ...
                        """Handle service removal - placeholder for zeroconf listener."""
