    ...
    async def _create_hidden_service(self) -> OnionAddress | None:
        ...
        try:
            ...
            response = self.controller.create_ephemeral_hidden_service(
                {80: 8888}, await_publication=True  # Map port 80 to local 8888
            )
...
class PrivacyTransport:
    ...
    def __init__(self, networks: PrivacyNetwork = PrivacyNetwork.BOTH, message_callback: Callable | None = None):
        """
