...
class DocumentContext:
    ...
    image_type: Optional[str] = None  # photograph, diagram, chart
...
class ChunkContext:
    ...
    narrative_position: Optional[str] = None  # setup, conflict, resolution
    
    # Image-specific
    image_region: Optional[str] = None  # "top-left", "center", etc.
...
class ContextualTagger:
    ...
    def __init__(
        ...
        self.domain_keywords = {
            ContentDomain.SCIENCE: [
                ...
                "theory", "methodology", "results", "conclusion", "peer-reviewed"
            ],
            ContentDomain.TECHNOLOGY: [
                "software", "algorithm", "programming", "system", "network", "database",
                "API", "framework", "architecture", "deployment", "code", "technical"
            ],
            ContentDomain.HISTORY: [
                "century", "ancient", "medieval", "war", "empire", "civilization",
                "historical", "timeline", "period", "era", "dynasty", "revolution"
            ],
            ContentDomain.LITERATURE: [
                "novel", "poetry", "narrative", "character", "plot", "theme",
                "author", "literary", "fiction", "genre", "story", "writing"
            ],
            ContentDomain.BUSINESS: [
                "company", "market", "revenue", "strategy", "management", "finance",
                "business", "corporate", "economics", "profit", "investment", "sales"
            ],
            ContentDomain.EDUCATION: [
                "learning", "teaching", "student", "curriculum", "education", "academic",
                "school", "university", "course", "textbook", "pedagogy", "instruction"
            ]
        }
        ...
        self.discourse_markers = {
            ...
            "summarization": ["in conclusion", "in summary", "to summarize", "overall", "in brief"],
            "temporal": ["first", "next", "then", "finally", "meanwhile", "subsequently"]
        }
    ...
    def _classify_document_type(
        ...
        elif content_length > 10000:  # ~4+ pages
    ...
    def _extract_keywords(self, text: str, limit: int = 20) -> List[str]:
        ...
        stop_words = {
            ...
            "said", "each", "which", "will", "would", "there", "could", "when"
        }
    ...
    def _extract_themes(
        ...
        theme_patterns = {
            ...
            "collaboration": ["collaboration", "cooperation", "partnership", "teamwork"],
            "sustainability": ["sustainability", "environmental", "green", "renewable"],
            "education": ["education", "learning", "knowledge", "teaching", "academic"],
            "technology": ["technology", "digital", "artificial", "automation", "innovation"]
        }
    ...
    def _create_inherited_context(
        self, document_context: DocumentContext, previous_chunk_context: Optional[ChunkContext]
    ) -> Dict[str, Any]:
