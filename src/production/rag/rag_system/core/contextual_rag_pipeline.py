    ...
    def _update_contextual_stats(
        ...
        if contextual_chunks:
            ...
            self.contextual_stats["avg_context_richness"] = (
                (current_avg * (total_docs - 1) + avg_richness) / total_docs
            )
        ...
        contextual_metrics = {
            ...
            "contextual_quality": {
                ...
                "context_coverage": (
                    ...
                    max(1, self.chunking_stats["intelligent_chunks_created"] + 
...
# Test function
async def test_contextual_rag_pipeline():
    ...
    test_queries = [
        {
            ...
            "filters": {"domain_filter": ContentDomain.SCIENCE, "reading_level_filter": ReadingLevel.GRADUATE}
        },
        {
            "query": "How do you implement microservices architecture?",
            "filters": {"domain_filter": ContentDomain.TECHNOLOGY, "min_credibility": 0.8}
        },
        {
    ...
    if (perf_metrics['meets_target'] and 
        contextual_quality['avg_context_richness'] > 0.6 and
        contextual_quality['context_coverage'] > 0.8):
