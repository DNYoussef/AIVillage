...
class WikipediaDataLoader:
    ...
    def _categorize_topic(self, topic: str) -> str:
        ...
        if any(term in topic_lower for term in ["learning", "intelligence", "neural", "algorithm", "computer", "python"]):
...
def create_sample_educational_content() -> list[Document]:
    ...
    samples = [
        ...
        Document(
            ...
            source_type="educational",
            metadata={"difficulty": "beginner", "subject": "Programming", "reading_time": 5}
        )
    ]
