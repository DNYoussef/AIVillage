...
from AIVillage.src.core.resources import AdaptiveLoader, ConstraintManager, DeviceProfiler, ResourceMonitor
from AIVillage.src.core.resources.constraint_manager import ConstraintSeverity, ConstraintViolation
...
class EvolutionResourceState:
    ...
    adaptation_strategy: ResourceAdaptationStrategy | None = None
...
class ResourceConstrainedEvolution(DualEvolutionSystem):
    ...
    def __init__(
        ...
        adaptive_loader: AdaptiveLoader | None = None,
        config: ResourceConstrainedConfig | None = None,
    ) -> None:
        ...
        self.current_resource_state: EvolutionResourceState | None = None
    ...
    async def _check_evolution_feasibility(self, evolution_type: str, agent: EvolvableAgent) -> bool:
        ...
        if constraints:
            ...
            # Battery check
            if (
                constraints.min_battery_percent
                and current_snapshot.battery_percent
    ...
    async def _execute_monitored_evolution(
        self, agent: EvolvableAgent, evolution_type: str, evolution_func: Callable
    ) -> bool:
    ...
    async def _determine_adaptation_strategy(
    ...
    ) -> ResourceAdaptationStrategy | None:
        ...
        if (
            "cpu" in constraint_types
            and self.config.enable_quality_degradation
            and evolution_type in ["nightly", "breakthrough"]
        ):
    ...
    async def _apply_adaptation_strategy(self, agent_id: str, strategy: ResourceAdaptationStrategy) -> None:
        ...
        for callback in self.adaptation_callbacks:
            try:
                ...
                logger.exception(f"Error in adaptation callback: {e}")

    async def _pause_evolution(self, agent_id: str) -> None:
    ...
    async def _resume_evolution(self, agent_id: str) -> None:
    ...
    async def _degrade_evolution_quality(self, agent_id: str) -> None:
    ...
    async def _reduce_evolution_scope(self, agent_id: str) -> None:
    ...
    async def _emergency_stop_evolution(self, agent_id: str) -> None:
    ...
    async def _cleanup_evolution_resources(self, evolution_id: str) -> None:
    ...
    async def _handle_constraint_enforcement(self, task_id: str, action: str) -> None:
