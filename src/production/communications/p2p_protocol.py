...
class P2PCommunicationProtocol(CommunicationProtocol):
    ...
    def get_p2p_status(self) -> dict[str, Any]:
        ...
        return {
            ...
            "mesh_status": self.device_mesh.get_mesh_status()
            if self.mesh_enabled
            else None,
    ...
    def get_performance_metrics(self) -> dict[str, Any]:
        ...
        return {
            ...
            "mesh_metrics": {
                "avg_latency_ms": self.device_mesh._calculate_average_latency()
                if self.mesh_enabled
                else 0,
                "avg_bandwidth_kbps": self.device_mesh._calculate_average_bandwidth()
                if self.mesh_enabled
                else 0,
                "network_diameter": self.device_mesh._calculate_network_diameter()
                if self.mesh_enabled
                else 0,
            },
