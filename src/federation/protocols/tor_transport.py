...
class TorTransport:
    ...
    async def start(self) -> bool:
        ...
        try:
            ...
            logger.info(f"Tor transport started successfully")
    ...
    async def create_circuit(self, 
                           purpose: str = "general",
                           min_hops: Optional[int] = None) -> Optional[str]:
        ...
        while self.is_running:
            try:
                ...
                if self.tor_controller:
                    ...
                    closed_circuits = [
                        cid for cid, circuit in self.circuits.items()
...
class TorFederationExtension:
    ...
    async def send_federation_message(self, 
                                    device_id: str, 
                                    message_type: str,
    ...
    async def broadcast_to_federation(self, 
                                    message_type: str,
