...
class TwinRuntimeChat:
    ...
    def _create_fallback_model(self):
        ...
        class SimpleChatModel(nn.Module):
            def __init__(self, vocab_size=50000, hidden=256):
                super().__init__()
    ...
    def _generate_response(self, prompt: str, temperature: float = 0.7, 
    ...
    def _simple_decode(self, tokens: list) -> str:
        ...
        return "I understand your query. Based on my analysis, " + \
