...
async def get_current_user(
    ...
    Falls back to an admin interface when authentication is unavailable to keep
...
class AdminAPI:
    ...
    def _setup_routes(self):
        ...
        async def get_node(
            ...
            # Production verification: user access to node's namespace

            # Update reference utilization data
        ...
        async def update_node_capacity(
            ...
            # Production node operator RBAC integration required
        ) -> NodeStatusResponse:
            ...
            # Reference implementation: node operator or admin verification
            ...
            if capacity_update.maintenance_mode:
                if node.status == NodeStatus.ACTIVE:
                    ...
                    # Reference implementation: workload draining
            ...
            # Reference implementation: scheduler capacity notification
        ...
        async def deregister_node(
            node_id: str,
            # Reference implementation: node operator RBAC dependency
        ):
            """Deregister fog node"""
            ...
            # Reference implementation: all workloads draining
            # await self._drain_node_workloads(node)

            # Reference implementation: scheduler stop notification
        ...
        async def node_heartbeat(
            ...
            # Reference implementation: node authentication
        ):
            ...
            # Reference implementation: heartbeat signature verification
