    ...
    async def verify_mfa(
        ...
        try:
            ...
            return SecurityResult(
                ...
                data={"method": method, "verified": True}
            )
...
class CertificateAuthenticationProvider(BaseAuthenticationProvider):
    ...
    async def authenticate_certificate(
        ...
        try:
            ...
            # Verify signature
            is_signature_valid = await self.certificate_store.verify_signature(
            ...
            if not user_id:
                return SecurityResult(
                    success=False,
                    message="Certificate does not contain user ID",
