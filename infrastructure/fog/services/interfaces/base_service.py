...
class ServiceEvent:
    ...
    def __init__(self, event_type: str, source_service: str, data: Dict[str, Any], timestamp: Optional[datetime] = None):
    ...
    async def _health_check_loop(self):
        ...
        while not self._shutdown_event.is_set():
            try:
                ...
                event = ServiceEvent("health_check", self.service_name, {
