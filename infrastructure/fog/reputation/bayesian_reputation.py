...
class ReputationConfig:
    ...
    # Event weights
    event_weights: Dict[EventType, float] = field(default_factory=lambda: {
...
class TrustComposition:
    ...
    def aggregate_tier_trust(
        self,
        node_scores: Dict[str, ReputationScore],
        tier_structure: Dict[ReputationTier, List[str]]
...
class BayesianReputationEngine:
    ...
    def export_state(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "event_counts": {
                node_id: len(events)
                for node_id, events in self.event_history.items()
            }
        }
...
def integrate_with_scheduler(reputation_engine: BayesianReputationEngine, scheduler_config: Dict[str, Any]) -> Dict[str, float]:
...
def integrate_with_pricing(reputation_engine: BayesianReputationEngine, base_prices: Dict[str, float]) -> Dict[str, float]:
