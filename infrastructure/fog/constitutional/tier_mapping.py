...
class ConstitutionalTierManager:
    ...
    async def validate_tier_compliance(self, user_id: str, workload_type: str, content_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if workload_type == "sensitive" and not capabilities.sensitive_workload_access:
            ...
            compliance_result["violations"].append(
                f"Sensitive workload access not allowed for {user_tier.value} tier"
            )
        ...
        impact = {
            ...
            "cost_impact": {
                ...
                "governance_fee_change": float(
                    target_capabilities.governance_fee_percentage - 
                    current_capabilities.governance_fee_percentage
                ),
            },
...
if __name__ == "__main__":
    ...
    async def demo_constitutional_tiers():
        ...
        compliance = await manager.validate_tier_compliance(
            user_id="demo_user",
            workload_type="sensitive", 
            content_data={"risk_score": 0.85}
        )
