...
# Relationship Types
RELATIONSHIP_TYPES = [
    "is_a", "part_of", "related_to", "influences", "causes",
    "enables", "requires", "conflicts_with", "similar_to", "derived_from"
]
...
__all__ = [
    'GapType', 'ConfidenceLevel', 'NodeType', 'GraphStatusCode',
    'SEMANTIC_SIMILARITY_BATCH_SIZE', 'MAX_GRAPH_NODES', 'GAP_DETECTION_TIMEOUT',
    'PROPOSAL_GENERATION_TIMEOUT', 'VALIDATION_TIMEOUT', 'SIMILARITY_THRESHOLD',
    'CONFIDENCE_THRESHOLD', 'MAX_PROPOSALS_PER_GAP', 'GRAPH_ANALYSIS_DEPTH',
    'EMBEDDING_DIMENSIONS', 'NEURAL_NETWORK_LAYERS', 'LEARNING_RATE', 'BATCH_SIZE',
    'EPOCHS', 'CACHE_TTL_SECONDS', 'CACHE_MAX_SIZE', 'CACHE_EVICTION_POLICY',
    'TARGET_PROCESSING_TIME', 'MAX_NODES_PER_BATCH', 'MAX_EDGES_PER_BATCH',
    'RELATIONSHIP_TYPES', 'QUALITY_THRESHOLDS', 'GRAPH_ERROR_MESSAGES',
    'DEFAULT_GRAPH_CONFIG'
]