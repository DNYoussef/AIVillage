...
class SystemMetricsManager:
            ...
            try:
                ...
                if self.average_collection_duration == 0:
                    ...
                    self.average_collection_duration = (
                        ...
                        (1 - alpha) * self.average_collection_duration
                    )
    ...
    def _create_snapshot(self, timestamp: datetime, metrics: Dict[str, Any]) -> SystemSnapshot:
        ...
        return SystemSnapshot(
            ...
            custom_metrics={k: v for k, v in metrics.items() 
                           if k not in ['cpu_percent', 'memory_percent', 'disk_percent',
    ...
    async def _check_thresholds(self, metrics: Dict[str, Any], timestamp: datetime) -> None:
        ...
        for metric_name, threshold in self.thresholds.items():
            ...
            is_critical = self._is_threshold_breached(avg_value, threshold.critical_threshold, threshold.comparison_operator)
            is_warning = self._is_threshold_breached(avg_value, threshold.warning_threshold, threshold.comparison_operator)
