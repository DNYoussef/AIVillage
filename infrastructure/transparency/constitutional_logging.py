...
class ConstitutionalDecisionLogger:
    ...
    async def log_constitutional_decision(
        ...
        public_disclosure_level = self._determine_disclosure_level(user_tier, decision_type, governance_level)
    ...
    def _determine_disclosure_level(
        self, user_tier: str, decision_type: ConstitutionalDecisionType, governance_level: GovernanceLevel
    ) -> str:
        ...
        # Silver tier - selective transparency
            ...
            if decision_type in [ConstitutionalDecisionType.GOVERNANCE_VOTE, ConstitutionalDecisionType.POLICY_UPDATE]:
    ...
    async def _capture_system_state(self) -> dict[str, Any]:
        ...
        return {
            ...
            "pending_appeals": len(
                [d for d in self.decision_logs if d.appeal_info and d.appeal_info.appeal_status == "pending"]
            ),
    ...
    async def resolve_appeal(
        self, appeal_id: str, resolution: DecisionOutcome, resolution_rationale: str, resolver: str
    ) -> str:
    ...
    def get_decision_analytics(self, time_range_hours: int = 24) -> dict[str, Any]:
        ...
        constitutional_decisions = len(
            [d for d in recent_decisions if d.governance_level == GovernanceLevel.CONSTITUTIONAL]
        )
        ...
        return {
            ...
            "appeal_statistics": {
                ...
                "appeal_rate": (
                    (appeals_pending + appeals_resolved) / len(recent_decisions) * 100 if recent_decisions else 0
                ),
            },
...
if __name__ == "__main__":
    ...
    async def test_constitutional_logging():
        ...
        appeal_id = await logger.register_appeal(
            decision_id, "user_12345", ["procedural_error", "disproportionate_response"]
        )
