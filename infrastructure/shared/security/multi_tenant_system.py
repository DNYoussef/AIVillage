...
class SQLSecurityManager:
    ...
    def build_parameterized_query(
        base_query: str, where_conditions: dict[str, Any], allowed_columns: set[str] | None = None
    ) -> tuple[str, list]:
    ...
    def validate_query_structure(query: str) -> None:
        ...
        if not any(
            keyword in query_lower for keyword in ["select", "insert", "update", "delete", "create", "alter", "drop"]
        ):
