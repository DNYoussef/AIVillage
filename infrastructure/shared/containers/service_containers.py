...
class FogServiceContainer(ServiceContainer):
    ...
    def _setup_fog_services(self):
        ...
        self.register_configuration("FogOrchestrationService", {
            "port": 8080,
            "enable_health_checks": True,
            "startup_timeout": 30
        })
        
        self.register_configuration("FogHarvestingService", {
            "min_battery_percent": 20,
            "max_thermal_temp": 45.0,
            "token_rate_per_hour": 10
        })
        
        self.register_configuration("FogPrivacyService", {
...
class GraphServiceContainer(ServiceContainer):
    ...
    def _setup_graph_services(self):
        ...
        self.register_configuration("GapDetectionService", {
            "similarity_threshold": 0.7,
            "batch_size": 32,
            "timeout_ms": 30000
        })
        
        self.register_configuration("KnowledgeProposalService", {
            "max_proposals_per_gap": 5,
            "confidence_threshold": 0.8,
            "ml_model_path": "models/knowledge_proposal"
        })
        
        self.register_configuration("GraphAnalysisService", {
            "max_nodes": 100000,
            "analysis_depth": 3,
            "enable_gpu": True
        })
...
__all__ = [
    'ServiceContainer', 'FogServiceContainer', 'GraphServiceContainer',
    'ServiceRegistry', 'ConfigurationManager',
    'fog_container', 'graph_container', 'service_registry', 'config_manager'
]