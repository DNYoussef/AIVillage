...
QUICK_RETRY = RetryConfig(max_attempts=3, base_delay=0.5, max_delay=5.0, backoff_type="exponential")

STANDARD_RETRY = RetryConfig(max_attempts=5, base_delay=1.0, max_delay=30.0, backoff_type="exponential")

PERSISTENT_RETRY = RetryConfig(max_attempts=10, base_delay=2.0, max_delay=120.0, backoff_type="exponential")
