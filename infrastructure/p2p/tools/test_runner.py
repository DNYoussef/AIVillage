...
class TestRunner:
    ...
    def register_test(self, name: str, description: str, category: str = "general", 
                     timeout: int = 30, prerequisites: List[str] = None):
...
async def test_package_imports(runner):
    ...
    try:
        from .. import P2PNetwork, NetworkConfig, create_network
