...
def validate_performance_improvements():
    ...
    improvement = benchmark.calculate_performance_improvement(
    ...
    print(f"Performance multiplier: {improvement['after_ops_per_sec'] / max(improvement['before_ops_per_sec'], 1):.1f}x")
...
def test_specific_optimizations():
    ...
    try:
        from credits_ledger import CreditsLedger, CreditsConfig
