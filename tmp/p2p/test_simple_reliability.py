...
class TestP2PReliability:
    ...
    def test_imports_available(self):
        ...
        try:
            from src.core.p2p.betanet_transport import BetanetTransport
            from src.core.p2p.bitchat_transport import BitChatTransport
            from src.core.p2p.dual_path_transport import (
                DualPathMessage,
                DualPathTransport,
            )
    ...
    async def test_message_handling(self):
        ...
        try:
            ...
            transport = DualPathTransport(
                node_id=node_id, enable_bitchat=True, enable_betanet=False
            )
            ...
            try:
                ...
                result = await asyncio.wait_for(
                    transport.send_message(
                        recipient="test_recipient", payload=b"test message", priority=5
                    ),
                    timeout=3.0,
                )
    ...
    def test_status_reporting(self):
        ...
        try:
            ...
            transport = DualPathTransport(
                node_id="status_test", enable_bitchat=True, enable_betanet=True
            )
