...
AGENTS = {
    "governance/legal_agent.py": {
        ...
        "capabilities": ["legal_research", "contract_drafting", "dispute_arbitration", "compliance_monitoring"]
    },
    "governance/auditor_agent.py": {
        ...
        "capabilities": ["financial_auditing", "receipt_verification", "risk_assessment", "compliance_monitoring"]
    },
    "knowledge/sage_agent.py": {
        ...
        "capabilities": ["knowledge_management", "research_leadership", "evidence_sourcing", "information_validation"]
    },
    "knowledge/curator_agent.py": {
        ...
        "capabilities": ["content_classification", "knowledge_gap_analysis", "domain_pack_maintenance", "content_tagging"]
    },
    "knowledge/oracle_agent.py": {
        ...
        "capabilities": ["mathematical_modeling", "physics_simulation", "chemistry_modeling", "scientific_computation"]
    },
    "knowledge/shaman_agent.py": {
        ...
        "capabilities": ["psychological_analysis", "cultural_pattern_recognition", "behavioral_modeling", "wisdom_synthesis"]
    },
    "knowledge/strategist_agent.py": {
        ...
        "capabilities": ["strategic_planning", "okr_management", "scenario_analysis", "roadmap_development"]
    },
    "language_education_health/polyglot_agent.py": {
        ...
        "capabilities": ["machine_translation", "dialect_processing", "cultural_nuance", "linguistic_analysis"]
    },
    "language_education_health/tutor_agent.py": {
        ...
        "capabilities": ["learner_assessment", "mastery_tracking", "lesson_generation", "personalized_learning"]
    },
    "language_education_health/medic_agent.py": {
        ...
        "capabilities": ["symptom_triage", "medical_referral", "health_assessment", "clinic_workflow"]
    },
    "economy/merchant_agent.py": {
        ...
        "capabilities": ["marketplace_management", "pricing_optimization", "payment_processing", "demand_routing"]
    },
    "economy/banker_economist_agent.py": {
        ...
        "capabilities": ["portfolio_management", "investment_strategy", "micro_lending", "capital_allocation"]
    },
    "infrastructure/magi_agent.py": {
        ...
        "capabilities": ["code_generation", "infrastructure_development", "model_training", "architecture_search"]
    },
    "infrastructure/navigator_agent.py": {
        ...
        "capabilities": ["path_routing", "mesh_networking", "dtn_protocols", "bandwidth_optimization"]
    },
    "infrastructure/gardener_agent.py": {
        ...
        "capabilities": ["system_maintenance", "cluster_management", "ux_optimization", "debt_cleanup"]
    },
    "infrastructure/sustainer_agent.py": {
        ...
        "capabilities": ["device_profiling", "resource_scheduling", "power_management", "cost_optimization"]
    },
    "infrastructure/coordinator_agent.py": {
        ...
        "capabilities": ["workflow_coordination", "agent_synchronization", "contention_resolution", "sla_monitoring"]
    },
    "culture_making/maker_agent.py": {
        ...
        "capabilities": ["digital_fabrication", "production_management", "design_to_manufacturing", "materials_management"]
    },
    "culture_making/ensemble_agent.py": {
        ...
        "capabilities": ["music_composition", "voice_synthesis", "video_production", "game_asset_creation"]
    },
    "culture_making/horticulturist_agent.py": {
        ...
        "capabilities": ["soil_management", "crop_optimization", "pest_management", "bio_engineering"]
    }
}
...
def create_init_files():
    ...
    domains = {
        ...
        "knowledge": ["SageAgent", "CuratorAgent", "OracleAgent", "ShamanAgent", "StrategistAgent"],
        "language_education_health": ["PolyglotAgent", "TutorAgent", "MedicAgent"], 
        "economy": ["MerchantAgent", "BankerEconomistAgent"],
        "infrastructure": ["MagiAgent", "NavigatorAgent", "GardenerAgent", "SustainerAgent", "CoordinatorAgent"],
