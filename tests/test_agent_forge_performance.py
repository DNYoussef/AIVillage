...
class TestAgentForgePerformance:
    ...
    def test_agent_forge_import_time_under_1s(self):
        ...
        assert import_time < 1.0, f"agent_forge import took {import_time:.2f}s, should be <1s"
    ...
    def test_agent_forge_lazy_initialization(self):
        ...
        assert construction_time < 0.1, f"AgentForge() took {construction_time:.2f}s, should be <0.1s"
