...
def test_integration_with_existing_systems(test_config):
    ...
    from agent_forge.training.curriculum import CurriculumGenerator
...
async def test_full_pipeline_smoke_test(test_config):
    ...
    with patch('agent_forge.training.magi_specialization.AutoModelForCausalLM') as mock_model_class, \
        ...
        mock_quietstar_baker.run_baking_pipeline = Mock(return_value={
            "winner": "thoughts",
            "improvement": 5.0,
