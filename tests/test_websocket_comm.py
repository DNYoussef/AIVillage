...
async def test_websocket_communication():
    ...
    print(f"Bidirectional communication: {'Yes' if any(r[0] == 'client' for r in received_messages) and any(r[0] == 'server' for r in received_messages) else 'No'}")
    print(f"Auto-reconnect tested: Yes")
    print(f"Message queuing tested: Yes")
    print(f"Broadcast tested: Yes")
    ...
    return {
        ...
        "bidirectional": any(r[0] == 'client' for r in received_messages) and any(r[0] == 'server' for r in received_messages),
