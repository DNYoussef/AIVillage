        ...
        return [
            ...
            TestDataSample(
                ...
                constitutional_considerations=[
                    "scientific_freedom",
                    "empirical_inquiry",
                    "evidence_based_discourse",
                    "academic_independence",
                ],
                protected_speech=True,
                edge_case=True,
...
DATASET_STATS = {
    ...
    "harm_level_distribution": {
        level.value: len(ConstitutionalTestDataFixtures.get_samples_by_harm_level(level)) for level in HarmLevel
    },
