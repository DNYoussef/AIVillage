...
from tests.fixtures.common_fixtures import parametrize_security_threats
...
class TestSecurityMonitoring(BaseSecurityTest):
    ...
    def test_security_alert_thresholds(self):
        ...
        should_alert_attempts = (
            current_metrics["failed_attempts_per_minute"] > alert_config["max_failed_attempts_per_minute"]
        )
...
class TestSecurityIntegration(BaseSecurityTest):
    ...
    async def test_end_to_end_security_pipeline(self):
        ...
        result = await self.run_integration_scenario("end_to_end_security_pipeline", scenario_steps)
