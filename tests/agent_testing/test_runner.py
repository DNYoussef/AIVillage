...
class TestRunner:
    ...
    def _run_pytest_suite(self, test_path: str, markers: List[str]) -> Dict[str, Any]:
        ...
        try:
            ...
            result = subprocess.run(
                cmd, cwd=str(self.base_path), capture_output=True, text=True, timeout=300  # 5 minute timeout
            )
            ...
            return {"status": "ERROR", "total": 0, "passed": 0, "failed": 0, "skipped": 0, "error": str(e)}
    ...
    def _generate_coverage_report(self, cov: coverage.Coverage):
        ...
        try:
            ...
            self.results["coverage"] = {"percentage": 0, "error": str(e), "status": "ERROR"}
