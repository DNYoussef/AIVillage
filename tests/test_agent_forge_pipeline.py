...
def test_agent_forge_pipeline():
    ...
    try:
        ...
        if REAL_IMPORTS:
            ...
            optimizer = create_grokfast_adamw(model, lr=1e-4)
    ...
    try:
        pipeline_path = str(Path(__file__).parent.parent / "core" / "agent-forge" / "phases" / "cognate_pretrain")
    ...
    try:
        ...
        optimizer = AugmentedAdam(params)
