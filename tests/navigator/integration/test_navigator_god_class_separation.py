...
from experiments.agents.agents.navigator.events.event_bus import initialize_event_bus
...
class TestNavigatorGodClassSeparation:
    ...
    async def test_service_separation_and_coordination(self, navigator_facade):
        ...
        expected_services = [
            "route_selection", "protocol_manager", "network_monitoring",
            "qos_manager", "dtn_handler", "energy_optimizer", "security_mixnode"
        ]
    ...
    async def test_route_selection_algorithm_separation(self, navigator_facade, message_context):
        ...
        costs = route_service.calculate_path_costs(
            "test_destination",
            ["bitchat", "betanet"],
            network_conditions
        )
    ...
    async def test_protocol_management_separation(self, navigator_facade):
        ...
        success = await protocol_manager.switch_protocol(
        ...
        fallback_protocol = await protocol_manager.handle_protocol_fallbacks(
            PathProtocol.SCION,  # Failed protocol
            "test_destination"
        )
    ...
    async def test_qos_management_separation(self, navigator_facade, message_context):
        ...
        qos_config = await qos_manager.manage_qos_parameters(
            PathProtocol.BETANET,
            message_context
        )
        ...
        adaptation_result = await qos_manager.adapt_bandwidth_usage(
    ...
    async def test_energy_optimization_separation(self, navigator_facade):
        ...
        efficient_paths = energy_optimizer.select_energy_efficient_paths(
            protocols,
    ...
    async def test_security_mixnode_separation(self, navigator_facade):
        ...
        privacy_config = security_service.ensure_routing_privacy(
            PathProtocol.BETANET,
            message_context
        )
    ...
    async def test_configuration_and_state_management(self, navigator_facade):
        ...
        original_mode = navigator_facade.energy_mode
        ...
        original_priority = navigator_facade.routing_priority
    ...
    async def test_concurrent_operations(self, navigator_facade, message_context):
        ...
        tasks = [
            navigator_facade.select_path(dest, message_context)
            for dest in destinations
        ]
    ...
    async def test_memory_and_cleanup(self, navigator_facade):
        ...
        initial_receipt_count = len(navigator_facade.receipts)
