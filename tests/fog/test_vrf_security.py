...
from fog.vrf.vrf_neighbor_selection import (
    VRFNeighborSelector, 
    NodeInfo, 
    VRFProof, 
    VRFStatus,
...
class TestEclipseAttackPrevention:
    ...
    def vrf_selector_with_reputation(self, reputation_engine):
        ...
        return VRFNeighborSelector(
            ...
            target_degree=6,
            eclipse_detection_threshold=0.6
        )
