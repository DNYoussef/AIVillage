...
class TestTopologyStability:
    ...
    async def test_topology_resilience_to_node_removal(self, stable_topology_manager):
        ...
        initial_spectral_gap = stable_topology_manager.current_metrics.spectral_gap if stable_topology_manager.current_metrics else 0
        ...
        final_spectral_gap = stable_topology_manager.current_metrics.spectral_gap if stable_topology_manager.current_metrics else 0
