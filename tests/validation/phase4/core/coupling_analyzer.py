...
class CouplingAnalyzer:
    ...
    def __init__(self, project_root: Path):
        ...
        self.baseline_scores = {"UnifiedManagement": 21.6, "SageAgent": 47.46, "task_management_average": 9.56}
    ...
    def _extract_dependencies(self, tree: ast.AST, content: str) -> Set[str]:
        ...
        import_patterns = [r'importlib\.import_module\(["\']([^"\']+)["\']', r'__import__\(["\']([^"\']+)["\']']
    ...
    def _count_incoming_dependencies(self, component_name: str) -> int:
        ...
        search_paths = [self.project_root / "swarm", self.project_root / "core", self.project_root / "infrastructure"]
    ...
    def _get_target_for_component(self, component: str) -> float:
        ...
        targets = {"UnifiedManagement": 8.0, "SageAgent": 25.0, "task_management_average": 6.0}
    ...
    async def run_legacy_coupling_analysis(self) -> Dict[str, Any]:
        ...
        try:
            result = subprocess.run(
                ["python", str(coupling_script)], capture_output=True, text=True, cwd=self.project_root
            )
