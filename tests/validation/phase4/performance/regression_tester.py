...
class RegressionTester:
    ...
    async def run_performance_tests(self) -> Dict[str, Any]:
        ...
        try:
            ...
            results["memory_trace"] = {"current_mb": current_memory / 1024 / 1024, "peak_mb": peak_memory / 1024 / 1024}
            ...
            tracemalloc.stop()
            return {"error": str(e), "passed": False, "total_execution_time_ms": int((time.time() - start_time) * 1000)}
    ...
    async def _test_memory_usage(self) -> Dict[str, Any]:
        ...
        results = {"baseline_memory_mb": baseline_memory / 1024 / 1024, "tests": []}
        ...
        for scenario_name, test_func in test_scenarios:
            try:
                ...
                results["tests"].append({"scenario": scenario_name, "error": str(e), "passed": False})
    ...
    async def _test_task_processing_throughput(self) -> Dict[str, Any]:
        ...
        results = {"tests": [], "baseline_throughput": 0, "current_throughput": 0}
        ...
        for task_count in task_counts:
            ...
            try:
                ...
                results["tests"].append({"task_count": task_count, "error": str(e), "passed": False})

        # Calculate overall throughput metrics
        valid_tests = [t for t in results["tests"] if "throughput_tasks_per_second" in t]
        if valid_tests:
            results["current_throughput"] = statistics.mean(t["throughput_tasks_per_second"] for t in valid_tests)
            results["max_throughput"] = max(t["throughput_tasks_per_second"] for t in valid_tests)
    ...
    async def _test_service_initialization_time(self) -> Dict[str, Any]:
        ...
        results = {"services": [], "total_init_time_ms": 0, "max_init_time_ms": 0, "avg_init_time_ms": 0}
        ...
        for service_name in services_to_test:
            try:
                ...
                results["services"].append({"service": service_name, "error": str(e), "passed": False})
        ...
        if init_times:
            ...
            results["passed"] = all(s.get("passed", False) for s in results["services"])
        else:
            results["passed"] = False
    ...
    async def _test_concurrent_operations(self) -> Dict[str, Any]:
        ...
        results = {"tests": [], "max_concurrent_supported": 0}
        ...
        for concurrency in concurrency_levels:
            ...
            try:
                ...
                results["tests"].append({"concurrency_level": concurrency, "error": str(e), "passed": False})
    ...
    async def _test_response_times(self) -> Dict[str, Any]:
        ...
        results = {"endpoints": [], "avg_response_time_ms": 0, "max_response_time_ms": 0, "p95_response_time_ms": 0}
    ...
    async def _test_resource_utilization(self) -> Dict[str, Any]:
        ...
        results["passed"] = (
            results["cpu_usage"]["max_percent"] < 80  # Max 80% CPU
            and results["memory_usage"]["max_percent"] < 90  # Max 90% memory
        )
    ...
    def _check_performance_targets(self, metrics: Dict[str, Any]) -> bool:
        ...
        checks = [
            ...
            metrics.get("performance_degradation_percent", float("inf"))
            <= self.targets["max_performance_degradation_percent"],
