...
class TestTaskCreationService:
    ...
    async def test_create_task_success(self, service):
        ...
        task = await service.create_task(description="Test task", agent="test_agent", priority=1)
...
class TestProjectManagementService:
    ...
    async def test_add_task_to_project(self, service):
        ...
        await service.add_task_to_project(project_id, "task_1", {"description": "Test task", "agent": "agent1"})
...
class TestUnifiedTaskManagerFacade:
    ...
    def facade(self):
        ...
        return UnifiedTaskManagerFacade(
            communication_protocol=communication_protocol, decision_maker=decision_maker, num_agents=5, num_actions=10
        )
