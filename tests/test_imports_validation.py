...
class TestImportValidation:
    ...
    def test_p2p_core_message_types(self):
        ...
        metadata = MessageMetadata(
            sender_id="test_sender", receiver_id="test_receiver", timestamp=1234567890, message_id="test_id"
        )
        assert metadata.sender_id == "test_sender"
        assert metadata.ttl == 10  # default value

        # Test UnifiedMessage creation
        unified_msg = UnifiedMessage(metadata=metadata, content={"test": "data"}, priority=MessagePriority.HIGH)
