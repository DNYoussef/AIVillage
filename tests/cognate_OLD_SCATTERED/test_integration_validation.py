...
class TestIntegrationValidation:
    ...
    def test_output_format_consistency(self, temp_output_dir):
        ...
        try:
            ...
            models1 = create_three_cognate_models(
                output_dir=temp_output_dir + "_1",
                device="cpu"
            )
            
            models2 = create_three_cognate_models(
            ...
            for i, (m1, m2) in enumerate(zip(models1, models2)):
                ...
                assert set(m1['metadata'].keys()) == set(m2['metadata'].keys()), \
    ...
    def test_metadata_evomerge_requirements(self, temp_output_dir):
        ...
        try:
            ...
            required_summary_fields = [
                'total_models', 'target_parameters_per_model', 'models',
                'total_parameters', 'average_parameters', 'parameter_accuracy',
                'next_phase', 'pipeline_status'
            ]
    ...
    def test_error_recovery_and_logging(self, temp_output_dir):
        ...
        try:
            ...
            assert "Cognate Model Factory" in log_output or "Creating" in log_output, \
                "Should have informative logging"
