    ...
    def setup_test_documents(self):
        ...
        self.test_documents = [
            Document(
                ...
                metadata={"domain": "technology", "complexity": "intermediate", "topics": ["AI", "ML", "NLP", "computer vision"]}
            ),
            ...
            Document(
                ...
                """,
                source_type="educational", 
                metadata={"domain": "environment", "complexity": "intermediate", "topics": ["climate", "environment", "sustainability"]}
            ),
            ...
            Document(
                ...
                """,
                source_type="educational",
                metadata={"domain": "technology", "complexity": "advanced", "topics": ["quantum", "computing", "algorithms"]}
            ),
            ...
            Document(
                ...
                """,
                source_type="educational",
                metadata={"domain": "energy", "complexity": "intermediate", "topics": ["renewable", "solar", "wind", "storage"]}
            )
        ]
    ...
    def setup_test_questions(self):
        ...
        self.test_questions = [
            # AI and Technology Questions
            {
                ...
                "expected_topics": ["AI", "machine learning", "algorithms", "human intelligence"],
                "expected_document": "ai_overview"
            },
            {
                "question": "What are the main applications of machine learning?",
                "expected_topics": ["machine learning", "applications", "data", "algorithms"],
                "expected_document": "ai_overview"
            },
            {
                "question": "How does natural language processing help computers understand text?",
                "expected_topics": ["NLP", "natural language processing", "text", "computers"],
                "expected_document": "ai_overview"
            },
            {
                "question": "What is computer vision and how does it analyze images?",
                "expected_topics": ["computer vision", "images", "visual", "neural networks"],
                "expected_document": "ai_overview"
            },
            ...
            # Climate and Environment Questions  
            {
                ...
                "expected_topics": ["climate change", "greenhouse gas", "CO2", "fossil fuels"],
                "expected_document": "climate_science"
            },
            {
                "question": "What are the main effects of climate change on the environment?",
                "expected_topics": ["temperature", "sea levels", "weather", "ecosystems"],
                "expected_document": "climate_science"
            },
            {
                "question": "How can we reduce greenhouse gas emissions?",
                "expected_topics": ["renewable energy", "mitigation", "emissions", "solar", "wind"],
                "expected_document": "climate_science"
            },
            ...
            },
            {
                ...
                "expected_topics": ["storage", "batteries", "intermittent", "grid stability"],
                "expected_document": "renewable_energy"
            },
            ...
            # Cross-domain Questions
            {
                ...
                "expected_topics": ["AI", "climate", "optimization", "renewable energy"],
