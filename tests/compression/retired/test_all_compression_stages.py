...
def test_real_seedlm():
    ...
    try:
        ...
        error = torch.norm(weights - decompressed) / torch.norm(weights)
        print(f"Reconstruction error: {error:.4f}")
        print(f"SeedLM status: WORKING")
        
        return ratio, total_size
        
    except Exception as e:
        print(f"SeedLM FAILED: {e}")
        print(f"SeedLM status: NOT WORKING")
        return 0, 0
...
def test_real_vptq():
    ...
    try:
        ...
        error = torch.norm(weights - decompressed) / torch.norm(weights)
        print(f"Reconstruction error: {error:.4f}")
        print(f"VPTQ status: WORKING")
        
        return ratio, total_size
        
    except Exception as e:
        print(f"VPTQ FAILED: {e}")
        print(f"VPTQ status: NOT WORKING")
        return 0, 0
...
def test_real_hyperfn():
    ...
    try:
        ...
        print(f"Time: {compress_time:.4f}s")
        print(f"HyperFn status: WORKING")
        
        return ratio, total_size
        
    except Exception as e:
        print(f"HyperFn FAILED: {e}")
        print(f"HyperFn status: NOT WORKING")
        return 0, 0
...
def main():
    ...
    print(f"Individual Stage Results:")
    ...
    if working_count >= 2 and pipeline_ratio > 10:
        ...
        print(f"  Status: FAILED - No stages working")
