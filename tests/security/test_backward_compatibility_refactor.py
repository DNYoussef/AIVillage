...
class TestLegacyAPICompatibility:
    ...
    async def test_legacy_health_endpoint_format(self):
        ...
        self.server.session_manager.health_check = AsyncMock(return_value={
            "status": "healthy",
            "latency_ms": 5
        })
        
        self.server.encryption.get_key_status.return_value = {
    ...
    def test_legacy_ssl_configuration(self):
        ...
        with patch('ssl.create_default_context') as mock_ssl:
            ...
            with patch('pathlib.Path.exists', return_value=True):
                ssl_context = self.server._create_ssl_context()
