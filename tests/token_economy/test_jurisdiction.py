...
def test_jurisdiction_detection_and_rules():
    ...
    ctx = UserContext(gps_location="China", ip_address=None, sim_country=None, device_locale=None)
    ...
    ctx2 = UserContext(gps_location="Kenya", ip_address=None, sim_country=None, device_locale=None)
