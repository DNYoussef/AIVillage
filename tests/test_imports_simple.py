...
sys.path.insert(0, os.path.join(os.path.dirname(__file__), "..", "core", "agent_forge", "phases", "cognate_pretrain"))
sys.path.insert(
    0, os.path.join(os.path.dirname(__file__), "..", "core", "agent_forge", "models", "cognate", "training")
)
