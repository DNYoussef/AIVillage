...
class CleanupAndCommitAgent:
    ...
    def __init__(self, work_dir: str = None):
        ...
        self.setup_logging()
        self.results = {"linting": {}, "cleanup": {}, "git_operations": {}, "errors": [], "warnings": []}
    ...
    def run_black_format(self, files: list[Path]) -> dict[str, Any]:
        ...
        result = self.run_command(
            ["black", "--line-length", "120", "--target-version", "py38", "--skip-string-normalization", "."],
            ignore_errors=True,
        )
    ...
    def git_status(self) -> dict[str, Any]:
        ...
        if result["success"]:
            ...
            status = {"modified": modified, "untracked": untracked, "staged": staged, "total_changes": len(lines)}
        else:
...
Co-Authored-By: AIVillage-Cleanup-Agent <cleanup@aivillage.dev>"""
    ...
    def git_commit(self, message: str) -> dict[str, Any]:
        ...
        # Create commit
        result = self.run_command(
            ["git", "commit", "-m", message, "--author", "AIVillage Cleanup Agent <cleanup@aivillage.dev>"]
        )
