...
class RAGAnswerGenerator:
    ...
    def generate_rule_based_answer(self, question: str, context: str, template_type: str = "informative") -> Dict[str, Any]:
        ...
        if template_type == "concise":
            ...
            answer = f"Based on the available information: {'. '.join(top_sentences)}. " \
    ...
    async def run_demonstration(self, questions: Optional[List[str]] = None) -> List[Dict[str, Any]]:
        ...
        for i, question in enumerate(questions):
            ...
            logger.info(f"Answer generated (confidence: {confidence_pct:.1f}%, "
