...
class STEMTextbookProcessor:
    ...
    def __init__(self, downloads_path: str = "C:/Users/17175/Downloads"):
    ...
    def classify_textbook_subject(self, text: str, filename: str) -> str:
        ...
        subjects = {
            'mathematics': ['calculus', 'algebra', 'geometry', 'statistics', 'probability', 'math', 'theorem', 'equation'],
            'physics': ['physics', 'quantum', 'mechanics', 'electromagnetism', 'thermodynamics', 'relativity', 'particle'],
            ...
            'computer_science': ['computer', 'programming', 'algorithm', 'software', 'machine learning', 'data structure'],
    ...
    def process_all_textbooks(self):
        ...
        logger.info(f"Processing complete: {self.processing_stats['books_processed']} books, "
    ...
    async def integrate_with_rag_systems(self, export_dir: Path):
