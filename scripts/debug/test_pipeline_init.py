...
def test_pipeline_initialization():
    ...
    try:
        ...
        def load_phase_module(phase_name):
            ...
            phase_path = project_root / "core" / "agent_forge" / "phases" / f"{phase_name}.py"
            ...
            try:
                ...
                # Find phase classes
                phase_classes = [
                    name for name in dir(module) if name.endswith("Phase") and isinstance(getattr(module, name), type)
                ]
