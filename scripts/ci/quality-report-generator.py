...
- **Quality Violations:** {len(violations)}"""
    ...
    def _generate_metrics_breakdown(self, quality_data: Dict) -> str:
        ...
        for metric in metrics:
            ...
            breakdown += f"| {name} | {value_str} | {threshold_str} | {status_emoji} | {level_emoji} {level.title()} |\n"
    ...
    def _generate_recommendations(self, quality_data: Dict) -> str:
        ...
        priority_order = [
            "coupling", "complexity", "magic", "god", "connascence", "anti-pattern"
        ]
...
def main():
    ...
    parser.add_argument("--fitness-report", type=str, required=True,
                       help="Path to fitness functions report")
    parser.add_argument("--coupling-report", type=str, required=True,
                       help="Path to coupling analysis report")
    parser.add_argument("--antipatterns-report", type=str, required=True,
                       help="Path to anti-patterns report")
    parser.add_argument("--quality-gate", type=str, required=True,
                       help="Path to quality gate results")
    parser.add_argument("--pr-number", type=int, required=True,
                       help="Pull request number")
    parser.add_argument("--output", type=str, default="pr_quality_report.md",
