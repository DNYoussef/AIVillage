...
class GraphRagAnalyzer:
    ...
    def __init__(self, ingested_papers_dir: str = "data/ingested_papers") -> None:
    ...
    def load_and_analyze_documents(self) -> None:
    ...
    def analyze_knowledge_gaps(self) -> None:
        ...
        if fragmented_topics:
            self.knowledge_gaps.append(
                {"type": "over_segmented_topics", "topics": fragmented_topics, "severity": "low"}
            )
        ...
        if poorly_connected_topics:
            self.knowledge_gaps.append(
                {"type": "poorly_connected_topics", "topics": poorly_connected_topics, "severity": "medium"}
            )
