...
def validate_workflow(workflow_path: Path) -> bool:
    ...
    try:
        ...
        try:
            ...
            print(f"  Warning: YAML parser encountered issues, attempting basic validation...")
            ...
            non_job_keys = {'name', 'on', 'jobs', 'env', 'defaults', 'concurrency', 'permissions'}
            ...
            print(f"  Basic structure detected: name={has_name}, triggers={has_on}, jobs={len(apparent_jobs) if apparent_jobs else 0}")
