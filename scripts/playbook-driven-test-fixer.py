...
class PlaybookDrivenTestFixer:
    ...
    def analyze_and_fix_with_playbooks(self, failure_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        print(f"🔍 Analyzing test failures with playbook decision trees...")
    ...
    def _select_playbook(self, classification: Dict[str, Any], failure_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        for playbook_name, playbook_info in self.playbooks.items():
            score = self._calculate_playbook_relevance_score(
                playbook_info, primary_type, severity, patterns
            )
        ...
        if not selected_playbook and 'flakes' in self.playbooks:
            selected_playbook = {
                'name': 'flakes',
                'info': self.playbooks['flakes'],
                'relevance_score': 0.5
            }
        
        return selected_playbook or {
            'name': 'generic',
            'info': {'data': {'stages': []}},
            'relevance_score': 0.1
        }
    
    def _calculate_playbook_relevance_score(self, playbook_info: Dict[str, Any], 
                                          primary_type: str, severity: str, 
    ...
    def _execute_playbook_phases(self, selected_playbook: Dict[str, Any], 
    ...
    def _execute_playbook_phase(self, phase: Dict[str, Any], 
                               failure_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _execute_harvest_phase(self, phase: Dict[str, Any], 
                              failure_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            if result.returncode == 0:
                ...
                return {
                    'success': False,
                    'error': f"Claude Flow analysis failed: {result.stderr}"
                }
                
        except Exception as e:
            return {'success': False, 'error': str(e)}
    
    def _execute_stabilize_phase(self, phase: Dict[str, Any], 
                                failure_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            if result.returncode == 0:
                ...
                return {
                    'success': False,
                    'error': f"Stabilization failed: {result.stderr}"
                }
                
        except Exception as e:
            return {'success': False, 'error': str(e)}
    
    def _execute_validate_phase(self, phase: Dict[str, Any], 
                               failure_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _execute_generic_phase(self, phase: Dict[str, Any], 
                              failure_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            if result.returncode == 0:
                ...
                return {
                    'success': False,
                    'error': f"Agent {agent_type} failed: {result.stderr}"
                }
                
        except Exception as e:
            return {'success': False, 'error': str(e)}
    
    def _create_harvest_prompt(self, failure_data: Dict[str, Any], 
                              phase: Dict[str, Any]) -> str:
...
"""
    ...
    def _create_stabilization_prompt(self, failure_data: Dict[str, Any], 
                                   phase: Dict[str, Any]) -> str:
...
"""
    ...
    def _create_generic_phase_prompt(self, phase: Dict[str, Any], 
...
def main():
    ...
    parser.add_argument('--failure-data', required=True, 
                       help='JSON file containing test failure data')
    parser.add_argument('--playbook', help='Specific playbook to use (optional)')
    parser.add_argument('--output-dir', default='.claude/test-failures',
