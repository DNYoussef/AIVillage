...
async def validate_imports():
    ...
    try:
        ...
        from infrastructure.p2p import (
            P2PNetwork, NetworkConfig, PeerInfo, 
            create_network, get_default_config
        )
        print_success("Core P2P imports successful")
        
        # Test advanced imports
        from infrastructure.p2p.advanced import (
            LibP2PEnhancedManager, NATTraversalOptimizer,
            ProtocolMultiplexer, LibP2PIntegrationAPI
        )
        print_success("Advanced P2P imports successful")
        
        # Test message delivery
        from infrastructure.p2p.core.message_delivery import (
            MessageDelivery, DeliveryStatus, MessagePriority
        )
        print_success("Message delivery imports successful")
        
        # Test message types
        from infrastructure.p2p.core.message_types import (
            Message, MessageType, MessagePriority as MsgPriority
        )
