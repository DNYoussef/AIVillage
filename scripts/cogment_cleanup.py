...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('cogment_migration.log'),
...
class CogmentMigrationManager:
    ...
    def _create_hrrm_backups(self) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.info(f"✓ HRRM backup created: {backup_result['files_backed_up']} files, {backup_result['backup_size_mb']:.1f}MB")
    ...
    def _verify_migration(self) -> Dict[str, Any]:
        ...
        try:
            ...
            verification_result["system_health"] = (
                verification_result["hrrm_removed"] and 
                verification_result["cogment_functional"]
            )
