...
class DecompositionValidator:
    ...
    async def validate_coupling_metrics(self):
        ...
        try:
            ...
            self.results["coupling_metrics"] = {
                ...
                "overall_success": all(
                    result.get("meets_target", False) for result in coupling_results.values() if "error" not in result
                ),
    ...
    async def validate_performance(self):
        ...
        try:
            ...
            performance_ok = (
                benchmarks["facade"]["initialization_time_ms"] < targets["max_init_time_ms"]
                and benchmarks["facade"]["gap_detection_time_ms"] < targets["max_gap_detection_ms"]
                and benchmarks["facade"]["proposal_time_ms"] < targets["max_proposal_time_ms"]
                and benchmarks["facade"]["comprehensive_analysis_time_ms"] < targets["max_comprehensive_ms"]
            )
    ...
    async def benchmark_facade_performance(self, config: ServiceConfig) -> Dict[str, float]:
        ...
        start = time.time()
        await facade.perform_comprehensive_analysis("test query", focus_area="AI")
    ...
    async def benchmark_service_performance(self, config: ServiceConfig) -> Dict[str, float]:
        ...
        for name, service in services.items():
            ...
            service_times[name] = {"init_time_ms": init_time, "is_functional": service.is_initialized}
    ...
    async def validate_architecture(self):
        ...
        try:
            ...
            print("   ✓ Architecture compliance checked")
    ...
    async def check_single_responsibility(self) -> bool:
        ...
        service_files = ["gap_detection_service.py", "node_proposal_service.py", "relationship_analyzer_service.py"]
    ...
    async def validate_services(self):
        ...
        try:
            ...
            self.results["service_functionality"] = {
                ...
                "all_functional": all(result["functional"] for result in service_results.values()),
            }
    ...
    async def validate_integration(self):
        ...
        try:
            ...
            integration_success = (
                facade.initialized and hasattr(result, "analysis_time_ms") and result.analysis_time_ms > 0
            )
    ...
    def create_test_config(self) -> ServiceConfig:
        ...
        config = ServiceConfig(
            trust_graph=Mock(), vector_engine=Mock(), min_confidence_threshold=0.3, cache_enabled=True
        )
        ...
        config.trust_graph.edges = {"edge1": Mock(source_id="test_node1", target_id="test_node2")}
    ...
    def generate_report(self) -> Dict[str, Any]:
        ...
        summary = {
            ...
            "sections_passed": sum(
                1 for key, _ in validation_sections if self.evaluate_section_success(key, self.results.get(key, {}))
            ),
