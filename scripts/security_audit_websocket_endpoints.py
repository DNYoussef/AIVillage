...
class WebSocketSecurityAuditor:
    ...
    def _is_websocket_file(self, content: str) -> bool:
        ...
        websocket_indicators = [
            'WebSocket', 'websocket', 'ws:', 'receive_text', 'send_json',
            'WebSocketDisconnect', 'websockets.', 'fastapi.*WebSocket'
        ]
    ...
    def save_report(self, report: SecurityReport, output_file: str) -> None:
        ...
        report_data = {
            'scan_summary': {
                ...
                'total_findings': len(report.critical_findings) + len(report.high_findings) + 
...
def main():
    ...
    parser.add_argument('--output', default='websocket_security_report.json', 
