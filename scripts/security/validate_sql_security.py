...
class SQLSecurityValidator:
    ...
    def check_file_for_sql_vulnerabilities(self, file_path: Path) -> List[Dict]:
        ...
        try:
            ...
            sql_patterns = [
                ...
                (r'(?:SELECT|INSERT|UPDATE|DELETE|CREATE|DROP|ALTER).*\+.*["\']', "String concatenation in SQL query"),
                ...
                (r"(?:SELECT|INSERT|UPDATE|DELETE|CREATE|DROP|ALTER).*\.format\(", ".format() used in SQL query"),
                # % formatting in SQL (potentially dangerous)
                (r"(?:SELECT|INSERT|UPDATE|DELETE|CREATE|DROP|ALTER).*%[sd]", "% formatting in SQL query"),
            ]
    ...
    def validate_codebase(self, root_path: Path) -> Dict:
        ...
        results = {"vulnerabilities": [], "secure_patterns": 0, "files_checked": 0, "summary": {}}
