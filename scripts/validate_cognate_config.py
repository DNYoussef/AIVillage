...
class CognateConfigValidator:
    ...
    def run_full_validation(self, environments: list[str] = None) -> dict[str, Any]:
        ...
        for env in environments:
            ...
            try:
                ...
                overall_results["environment_results"][env] = {
    ...
    def validate_environment(self, environment: str) -> dict[str, Any]:
        ...
        try:
            ...
            has_errors = any(
                ...
                for section in ["config_loading", "parameter_validation", "functional_validation", "integration_validation"]
            )
    ...
    def test_parameter_validation(self, environment: str) -> dict[str, Any]:
        ...
        try:
            ...
            results["tests"]["parameter_estimation"] = {
                "status": "passed",
                "estimated_count": param_count
            }
    ...
    def test_integration_validation(self, environment: str) -> dict[str, Any]:
        ...
        try:
            ...
            try:
                pipeline_config_path = self.config_dir.parent.parent / "agent_forge" / "cognate" / "pipeline_integration.yaml"
        ...
        try:
            ...
            if summary["failed"] > 0:
                recommendations.append(
                    f"Fix configuration issues in {summary['failed']} failed environment(s)"
                )
                
            if summary["warnings"] > summary["passed"]:
                recommendations.append(
                    "Address configuration warnings to improve system reliability"
                )
