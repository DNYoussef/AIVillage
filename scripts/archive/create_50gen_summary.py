...
def create_comprehensive_summary():
    ...
    print(
        f"Duration:                  {summary['duration_minutes']:.2f} minutes ({summary['duration_seconds']:.1f} seconds)"
    )
    print(
    ...
    print("\nCOMPARISON WITH 10-GENERATION RUN:")
    print("-" * 50)
    print("  10-Gen Best Fitness:     1.012")
    ...
    print("configuration that significantly outperforms the 10-generation baseline!")
