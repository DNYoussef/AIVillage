...
async def validate_decomposition():
    ...
    try:
        ...
        performance_ok = (
            init_time < MAX_INIT_TIME and
            gap_time < MAX_GAP_TIME and
    ...
    try:
        ...
        checks = {
            "Services package": (project_root / "core" / "hyperrag" / "cognitive" / "services" / "__init__.py").exists(),
            "Interfaces package": (project_root / "core" / "hyperrag" / "cognitive" / "interfaces" / "__init__.py").exists(),
            "Facades package": (project_root / "core" / "hyperrag" / "cognitive" / "facades" / "__init__.py").exists(),
            "Base service interface": (project_root / "core" / "hyperrag" / "cognitive" / "interfaces" / "base_service.py").exists(),
            "Service interfaces": (project_root / "core" / "hyperrag" / "cognitive" / "interfaces" / "service_interfaces.py").exists(),
            "Main facade": (project_root / "core" / "hyperrag" / "cognitive" / "facades" / "graph_fixer_facade.py").exists()
        }
