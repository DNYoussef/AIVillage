...
class WikipediaIngestion:
    ...
    def __init__(self, target_articles: int = 1000):
        ...
        self.categories = [
            ...
            "Biology", "Computer_science", "Engineering", "Medicine", "Education",
            "History", "Geography", "Literature", "Philosophy", "Psychology",
            "Economics", "Artificial_intelligence", "Machine_learning", "Space",
            "Climate_change", "Renewable_energy", "Quantum_physics", "Genetics"
        ]
    ...
    def filter_quality_articles(self, articles: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
        ...
        for article in articles:
            ...
            if any(skip_term in title.lower() for skip_term in [
                "disambiguation", "list of", "category:", "template:", "user:"
            ]):
                continue
