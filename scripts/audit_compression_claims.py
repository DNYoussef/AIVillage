...
def audit_seedlm():
    ...
    for bits in [3, 4]:
        ...
        print(f"  - metadata: {comp_bytes - compressed['seeds'].nbytes - compressed['coefficients'].nbytes - compressed['shared_exponents'].nbytes} bytes")
        print(f"Actual ratio: {ratio:.2f}x")
        ...
        print(f"Paper claims: 8x for 4-bit")
