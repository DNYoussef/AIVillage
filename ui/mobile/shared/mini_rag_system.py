"""
On-Device Mini-RAG System for Digital Twin Concierge
...
anonymized insights to the global knowledge base managed by Sage and Curator agents.
"""
...
class MiniRAGSystem:
    """
    Lightweight RAG system running entirely on device for digital twin
