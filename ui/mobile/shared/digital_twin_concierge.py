...
try:
    from .mini_rag_system import MiniRAGSystem
    from .resource_manager import MobileDeviceProfile, MobileResourceManager
    ...
    def _setup_database(self):
        ...
        with sqlite3.connect(self.db_path) as conn:
            ...
            conn.execute(
                ...
                CREATE INDEX IF NOT EXISTS idx_source ON data_points(source);
                CREATE INDEX IF NOT EXISTS idx_surprise ON data_points(surprise_score);
            """
            )
