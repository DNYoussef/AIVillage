...
def sample_ui_config():
    ...
    return {
        "web": {"port": 3000, "host": "localhost", "api_base_url": "http://localhost:8000", "enable_admin": True},
        "mobile": {
        ...
        "cli": {"default_command": "dashboard", "log_level": "INFO", "auto_refresh": True},
    }
...
def cleanup_test_files():
    ...
    test_patterns = ["test_*.tmp", "*.test.log", "test_output_*"]
