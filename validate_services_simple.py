...
SERVICES = [
    ...
    {"name": "Digital Twin API", "host": "localhost", "port": 8080, "type": "http", "path": "/health/twin"},
    {"name": "Evolution Metrics API", "host": "localhost", "port": 8081, "type": "http", "path": "/health/evolution"},
    {"name": "RAG Pipeline API", "host": "localhost", "port": 8082, "type": "http", "path": "/health/rag"},
