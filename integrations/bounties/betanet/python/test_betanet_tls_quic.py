...
class TestBetanetTLSQUIC:
    ...
    async def test_can_open_stream_and_echo_tls(self):
        ...
        async def echo_handler(message: BetanetMessage):
            # Echo back to sender
            await server_transport.send_message(message.sender, message.payload, protocol="htx/1.1")
        ...
        try:
            ...
            success = await client_transport.send_message("server_node", test_payload, protocol="htx/1.1")
