"""Legal Agent - Law, Policy, Contracts"""
...
class LegalAgent(AgentInterface):
    """Law, Policy, Contracts"""
    ...
    async def generate(self, prompt: str) -> str:
        return "I am Legal Agent, responsible for Law, Policy, Contracts."
    ...
    async def communicate(self, message: str, recipient: "AgentInterface") -> str:
        if recipient:
            response = await recipient.generate(f"Legal Agent says: {message}")
